...
### 2.2 Docker Compose and Modules
The modules directory contains Docker Compose files that specify which nodes should startup.

#### 2.2.1 Do I need to create my own Module (docker compose file)?
Contact your lead. Usually your ROS2 node will not need its own Module. It is up to your lead to decide whether your node should startup with a Module of their choosing.
