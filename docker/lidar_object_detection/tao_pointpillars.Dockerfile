...
COPY src/ros2_tao_pointpillars/model /model/pointpillars_model
RUN nvidia-smi >&2
...
COPY src/ros2_tao_pointpillars/lidar_object_detection pointpillars_ws
...
# Must run with DOCKER_BUILDKIT=0 ./watod2 up --build
