...
DATA_STREAM_IMAGE=${DATA_STREAM_IMAGE:-"git.uwaterloo.ca:5050/watonomous/wato_monorepo/data_stream"}
## -------------------------- User ID -----------------------------
...
echo "DATA_STREAM_IMAGE=$DATA_STREAM_IMAGE" >> "$PROFILES_DIR/.env"
