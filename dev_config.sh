...
WORLD_MODELING_HD_MAP_AVERAGE_FILTER_IMAGE=${WORLD_MODELING_HD_MAP_AVERAGE_FILTER_IMAGE:-"git.uwaterloo.ca:5050/watonomous/wato_monorepo/world_modeling_hd_map_average_filter"}
...
echo "WORLD_MODELING_HD_MAP_AVERAGE_FILTER_IMAGE=$WORLD_MODELING_HD_MAP_AVERAGE_FILTER_IMAGE" >> "$PROFILES_DIR/.env"
