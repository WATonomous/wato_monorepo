...
WORLD_MODELING_SAMPLE_AVERAGER_IMAGE=${WORLD_MODELING_SAMPLE_AVERAGER_IMAGE:-"git.uwaterloo.ca:5050/watonomous/wato_monorepo/world_modeling_sample_averager"}
...
echo "WORLD_MODELING_SAMPLE_AVERAGER_IMAGE=$WORLD_MODELING_SAMPLE_AVERAGER_IMAGE" >> "$PROFILES_DIR/.env"
