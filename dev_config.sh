...
WORLD_MODELING_HD_MAP_PROJECTOR_IMAGE=${WORLD_MODELING_HD_MAP_PROJECTOR_IMAGE:-"git.uwaterloo.ca:5050/watonomous/wato_monorepo/world_modeling_hd_map_projector"}
...
echo "WORLD_MODELING_HD_MAP_PROJECTOR_IMAGE=$WORLD_MODELING_HD_MAP_PROJECTOR_IMAGE" >> "$PROFILES_DIR/.env"
