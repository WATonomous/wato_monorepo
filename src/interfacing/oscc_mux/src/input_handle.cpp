...
, cfg_(cfg)
{
  sub_cmd_ = node_->create_subscription<roscco_msg::msg::Roscco>(
...
void InputHandle::on_cmd_callback(const roscco_msg::msg::Roscco::ConstSharedPtr msg)
{
...
roscco_msg::msg::Roscco InputHandle::last_cmd() const
{
  std::scoped_lock<std::mutex> lk(mtx_);
  return last_cmd_;
}
