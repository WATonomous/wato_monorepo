...
WHEN("^an enable throttle command is received$")
{
  ...
  oscc_throttle_enable_s * throttle_enable = (oscc_throttle_enable_s *)g_mock_mcp_can_read_msg_buf_buf;
...
WHEN("^a disable throttle command is received$")
{
  ...
  oscc_throttle_disable_s * throttle_disable = (oscc_throttle_disable_s *)g_mock_mcp_can_read_msg_buf_buf;
...
WHEN("^a command is received with request value (.*)$")
{
  ...
  oscc_throttle_command_s * throttle_command = (oscc_throttle_command_s *)g_mock_mcp_can_read_msg_buf_buf;
