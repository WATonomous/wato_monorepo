...
BEFORE()
{
  ...
  vehicle_defines["STEERING_SPOOF_LOW_SIGNAL_RANGE_MIN"] = STEERING_SPOOF_LOW_SIGNAL_RANGE_MIN;
  vehicle_defines["STEERING_SPOOF_LOW_SIGNAL_RANGE_MAX"] = STEERING_SPOOF_LOW_SIGNAL_RANGE_MAX;
  vehicle_defines["STEERING_SPOOF_HIGH_SIGNAL_RANGE_MIN"] = STEERING_SPOOF_HIGH_SIGNAL_RANGE_MIN;
  vehicle_defines["STEERING_SPOOF_HIGH_SIGNAL_RANGE_MAX"] = STEERING_SPOOF_HIGH_SIGNAL_RANGE_MAX;
  vehicle_defines["THROTTLE_SPOOF_LOW_SIGNAL_RANGE_MIN"] = THROTTLE_SPOOF_LOW_SIGNAL_RANGE_MIN;
  vehicle_defines["THROTTLE_SPOOF_LOW_SIGNAL_RANGE_MAX"] = THROTTLE_SPOOF_LOW_SIGNAL_RANGE_MAX;
  vehicle_defines["THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MIN"] = THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MIN;
  vehicle_defines["THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MAX"] = THROTTLE_SPOOF_HIGH_SIGNAL_RANGE_MAX;
#ifndef KIA_SOUL
  vehicle_defines["BRAKE_SPOOF_LOW_SIGNAL_RANGE_MIN"] = BRAKE_SPOOF_LOW_SIGNAL_RANGE_MIN;
  vehicle_defines["BRAKE_SPOOF_LOW_SIGNAL_RANGE_MAX"] = BRAKE_SPOOF_LOW_SIGNAL_RANGE_MAX;
  vehicle_defines["BRAKE_SPOOF_HIGH_SIGNAL_RANGE_MIN"] = BRAKE_SPOOF_HIGH_SIGNAL_RANGE_MIN;
  vehicle_defines["BRAKE_SPOOF_HIGH_SIGNAL_RANGE_MAX"] = BRAKE_SPOOF_HIGH_SIGNAL_RANGE_MAX;
#endif
}
