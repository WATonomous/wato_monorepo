...
#define BEFORE_WITH_NAME_(step_name, tag_expression)                                                              \
  CUKE_OBJECT_(step_name, ::cucumber::internal::BeforeHook, BEFORE_HOOK_REGISTRATION_(step_name, tag_expression)) \
  /**/
...
#define AROUND_STEP_WITH_NAME_(step_name, tag_expression)                                                       \
  CUKE_OBJECT_(                                                                                                 \
    step_name, ::cucumber::internal::AroundStepHook, AROUND_STEP_HOOK_REGISTRATION_(step_name, tag_expression)) \
  /**/
...
#define AFTER_STEP_WITH_NAME_(step_name, tag_expression)                                                      \
  CUKE_OBJECT_(                                                                                               \
    step_name, ::cucumber::internal::AfterStepHook, AFTER_STEP_HOOK_REGISTRATION_(step_name, tag_expression)) \
  /**/
...
#define AFTER_WITH_NAME_(step_name, tag_expression)                                                             \
  CUKE_OBJECT_(step_name, ::cucumber::internal::AfterHook, AFTER_HOOK_REGISTRATION_(step_name, tag_expression)) \
  /**/
...
#define BEFORE_ALL_WITH_NAME_(step_name)                                                                 \
  CUKE_OBJECT_(step_name, ::cucumber::internal::BeforeAllHook, BEFORE_ALL_HOOK_REGISTRATION_(step_name)) \
  /**/

#define BEFORE_ALL_HOOK_REGISTRATION_(step_name) ::cucumber::internal::registerBeforeAllHook<step_name>() /**/
...
#define AFTER_ALL_WITH_NAME_(step_name)                                                                \
  CUKE_OBJECT_(step_name, ::cucumber::internal::AfterAllHook, AFTER_ALL_HOOK_REGISTRATION_(step_name)) \
  /**/

#define AFTER_ALL_HOOK_REGISTRATION_(step_name) ::cucumber::internal::registerAfterAllHook<step_name>() /**/
