...
namespace watonomous
{
      ...
      const rclcpp_lifecycle::State &)
  {
    ...
    node->declare_parameter("radar_detection_topic_name", rclcpp::ParameterValue("ars408/radar_detection"));
  ...
  void radar_conti_ars408::initializeFilterConfigs()
  {
    ...
    {
      for (size_t filter_index = 0; filter_index < MAX_FilterState_Cfg_FilterState_Index; filter_index++)
      {
  ...
  void radar_conti_ars408::can_receive_callback(const can_msgs::msg::Frame::SharedPtr frame)
  {
    ...
    {
      operation_mode_ = CALC_RadarState_RadarState_OutputTypeCfg(GET_RadarState_RadarState_OutputTypeCfg(frame->data), 1.0);
    }
  ...
  void radar_conti_ars408::handle_object_list(const can_msgs::msg::Frame::SharedPtr frame)
  {
    ...
    if (Get_MsgID0_From_MsgID(frame->id) == ID_Obj_1_General)
    {
      ...
      o.pos_x =
          CALC_Obj_1_General_Obj_DistLong(GET_Obj_1_General_Obj_DistLong(frame->data), 1.0);

      // lateral distance
      o.pos_y =
          CALC_Obj_1_General_Obj_DistLat(GET_Obj_1_General_Obj_DistLat(frame->data), 1.0);
      ...
      o.rcs0 =
          CALC_Obj_1_General_Obj_RCS(GET_Obj_1_General_Obj_RCS(frame->data), 1.0);
  ...
  void radar_conti_ars408::updateFilterConfig(const can_msgs::msg::Frame::SharedPtr frame, const int &sensor_id)
  {
