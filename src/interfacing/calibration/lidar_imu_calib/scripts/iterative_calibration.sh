...
YAML_FILE="/ws/install/lidar_imu_calib/share/lidar_imu_calib/config/velodyne.yaml"
RESULTS_CSV="/ws/src/interfacing/calibration/lidar_imu_calib/scripts/calibration_results.csv"
LOG_DIR="/ws/src/interfacing/calibration/lidar_imu_calib/scripts/calibration_logs"
