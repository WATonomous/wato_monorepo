...
Based on [lidar_imu_calib](https://github.com/hku-mars/lidar_imu_calib) by the HKU MaRS Lab.
ROS2 port by [morte2025](https://github.com/morte2025/lidar_imu_calib_ROS2).
...
colcon build --packages-select lidar_imu_calib --cmake-args -DCMAKE_BUILD_TYPE=Release
...
ros2 run lidar_imu_calib li_init \
  ...
  --params-file /path/to/install/lidar_imu_calib/share/lidar_imu_calib/config/velodyne.yaml
```
...
GPLv2. See the [original repository](https://github.com/hku-mars/lidar_imu_calib) for details.
