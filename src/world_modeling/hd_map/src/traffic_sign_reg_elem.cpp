...
std::shared_ptr<TrafficSignRegElem> TrafficSignRegElem::make(const lanelet::BoundingBox3d& bbox, const TrafficSignSubtype& subtype, uint64_t id) {

  auto traffic_sign = utils::boundingBox3dToPolygon3d(bbox);

  lanelet::RuleParameterMap rpm = {
      {lanelet::RoleNameString::Refers, {traffic_sign}}};
