...
class TrafficLightRegElem : public lanelet::RegulatoryElement {
 public:
  ...
  static std::shared_ptr<TrafficLightRegElem> make(const lanelet::BoundingBox3d& bbox,
 ...
 private:
  ...
  explicit TrafficLightRegElem(const lanelet::RegulatoryElementDataPtr& data,
                               const TrafficLightState& state, uint64_t id = 0);
};
