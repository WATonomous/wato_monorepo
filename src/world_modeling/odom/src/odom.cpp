...
WheelOdometry::WheelOdometry()
  ...
  leftrear_wheel_motor_encoder = this->create_subscription<std_msgs::msg::Float64>(
      "/motor_encoder_left", 10,
      std::bind(&WheelOdometry::defineVariables, this, std::placeholders::_1, "left_encoder"));

  rightrear_wheel_motor_encoder = this->create_subscription<std_msgs::msg::Float64>(
      "/motor_encoder_right", 10,
      std::bind(&WheelOdometry::defineVariables, this, std::placeholders::_1, "right_encoder"));

  steering_angle = this->create_subscription<std_msgs::msg::Float64>(
      "/steering_angle", 10,
      std::bind(&WheelOdometry::defineVariables, this, std::placeholders::_1, "steering_angle"));

  publisher_ = this->create_publisher<std_msgs::msg::Float64>("/bicycle_model_output", 10);
}

void WheelOdometry::defineVariables(const std_msgs::msg::Float64::SharedPtr msg,
