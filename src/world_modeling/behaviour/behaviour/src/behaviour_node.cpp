...
void BehaviourNode::init()
{
  ...
  current_lane_context_sub_ = this->create_subscription<lanelet_msgs::msg::CurrentLaneContext>(
    "/world_modeling/lanelet/lane_context", 10, [this](const lanelet_msgs::msg::CurrentLaneContext::SharedPtr msg) {
  ...
  dynamic_objects_sub_ = this->create_subscription<world_model_msgs::msg::WorldObjectArray>(
    "/world_modeling/world_objects",
    rclcpp::QoS(10),
    [this](world_model_msgs::msg::WorldObjectArray::ConstSharedPtr msg) { dynamic_objects_store_->update(msg); });

  area_occupancy_sub_ = this->create_subscription<world_model_msgs::msg::AreaOccupancy>(
    "/world_modeling/area_occupancy",
    rclcpp::QoS(10),
    [this](world_model_msgs::msg::AreaOccupancy::ConstSharedPtr msg) { area_occupancy_store_->update(msg); });
