...
namespace behaviour
{
  ...
  public:
    ...
    BT::NodeStatus tick() override
    {
      ...
      {
        std::cout << "[ActiveTrafficControlElementPassed] ego on intersection lanelet " << ego_id
                  << " — not passed" << std::endl;
        return BT::NodeStatus::FAILURE;
      }
      ...
      std::cout << "[ActiveTrafficControlElementPassed] ego lanelet=" << ego_id
                << " active_lanelet=" << active_id << " — PASSED" << std::endl;
