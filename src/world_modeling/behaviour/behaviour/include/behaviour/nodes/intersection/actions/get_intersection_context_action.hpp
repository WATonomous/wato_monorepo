...
namespace behaviour
{
   ...
   * @brief Builds and latches the active traffic-control element for the upcoming intersection.
   *
   *
   * Classify logic: traffic light > stop_sign > yield.
   */
  ...
  public:
    ...
    {
      auto active_traffic_control_element = ports::tryGetPtr<lanelet_msgs::msg::RegulatoryElement>(*this, "in_active_traffic_control_element");
