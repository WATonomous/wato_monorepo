...
{
  if (str == "TRAFFIC_LIGHT") return behaviour::types::TrafficControlElementType::TRAFFIC_LIGHT;
  if (str == "STOP_SIGN") return behaviour::types::TrafficControlElementType::STOP_SIGN;
  if (str == "YIELD") return behaviour::types::TrafficControlElementType::YIELD;
