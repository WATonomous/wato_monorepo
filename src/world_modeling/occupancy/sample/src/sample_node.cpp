...
: Node("sample"), sample_(world_modeling::occupancy::Sample())
{
  ...
  sample_pub_ =
    this->create_publisher<sample_msgs::msg::Unfiltered>("occupancy_sample_topic", ADVERTISING_FREQ);
...
void SampleNode::sample_publish(const sample_msgs::msg::Unfiltered::SharedPtr msg)
{
  auto pub_msg = sample_msgs::msg::Unfiltered(); 
    RCLCPP_INFO(this->get_logger(), "Publishing Sample Message from Occupancy...\n");
