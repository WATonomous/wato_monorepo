...
TEST(PathGenerator, test_generatePathForNonVehicleObject)
{
  ...
  const motion_forecasting::PathGenerator path_generator = motion_forecasting::PathGenerator(
...
TEST(PathGenerator, test_generatePathForOnLaneVehicle)
{
  ...
  motion_forecasting::PosePath ref_paths;
...
TEST(PathGenerator, test_generatePathForCrosswalkUser)
{
  ...
  motion_forecasting::CrosswalkEdgePoints reachable_crosswalk;
