...
def local_to_utm(local_x: float, local_y: float, local_z: float,
...
def convert_osm(input_path: str, output_path: str,
                offset_x: float, offset_y: float, offset_z: float,
                utm_zone: int, is_north: bool, yaw: float):
    ...
    for node in root.iter("node"):
        ...
        utm_e, utm_n, utm_z = local_to_utm(
            ...
            offset_x, offset_y, offset_z, yaw)
...
def main():
    ...
    count = convert_osm(args.input, args.output,
                        offset_x, offset_y, offset_z,
                        utm_zone, is_north, yaw)
