...
namespace behaviour_markers
{
      ...
      : Node("behaviour_markers_node")
  {
    ...
    lanelet_ahead_sub_ = create_subscription<lanelet_msgs::msg::LaneletAhead>(
        "lanelet_ahead", 10,
        std::bind(&BehaviourMarkersNode::laneletAheadCallback, this, std::placeholders::_1));

    RCLCPP_INFO(get_logger(), "BehaviourMarkersNode initialized");
  }

  void BehaviourMarkersNode::executeBehaviourCallback(
      const behaviour_msgs::msg::ExecuteBehaviour::SharedPtr msg)
  {
