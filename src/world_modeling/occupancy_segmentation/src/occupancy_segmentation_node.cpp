...
: Node("occupancy_segmentation"), occupancy_segmentation_(world_modeling::OccupancySegmentationCore())
{
  data_pub_ =
...
rcl_interfaces::msg::SetParametersResult OccupancySegmentationNode::parameters_callback(
