...
public:
  ...
  void configure(double relinearize_threshold, int relinearize_skip,
  ...
  int getUpdateIterations() const { return update_iterations_; }
  int getCorrectionIterations() const { return correction_iterations_; }
  int getLoopClosureIterations() const { return loop_closure_iterations_; }
