...
#include "pubsub_sample_cpp/msg/filtered.hpp"
...
private:
   ...
   */
  void publish_buffer(const pubsub_sample_cpp::msg::Filtered & msg);
...
private:
  ...
  rclcpp::Publisher<pubsub_sample_cpp::msg::FilteredArray>::SharedPtr transform_pub_;

  // Buffer storing processed messages until BUFFER_CAPACITY. Clear after
  // messages are published.
  std::vector<pubsub_sample_cpp::msg::Filtered> buffer_;
};
