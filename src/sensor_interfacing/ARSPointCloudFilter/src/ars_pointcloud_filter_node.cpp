...
ARSPointCloudFilterNode::ARSPointCloudFilterNode(): Node("ars_point_cloud_filter")
{
  ...
  "unfilteredRadarLeft", 1 , std::bind(&ARSPointCloudFilterNode::unfiltered_ars_radar_left_callback, 
    this, std::placeholders::_1));

  raw_right_sub_ = this->create_subscription<radar_msgs::msg::RadarPacket>(
  "unfilteredRadarRight", 1 , std::bind( &ARSPointCloudFilterNode::unfiltered_ars_radar_right_callback, 
    this, std::placeholders::_1));
  ...
  const radar_msgs::msg::RadarPacket::SharedPtr msg)
{
  ...
  /**
  * Scan Mode == Near
  * @brief Send incoming scan message to Near Scan filter and append detections to buffer packet based on timestamp.
  ...
  */
  ...
  /**
  * Scan Mode == Far
  * @brief Send incoming scan message to Far Scan filter and append detections to buffer packet based on timestamp.
           Check if packet is ready to be published. Return true if ready, return false otherwise.
  */
