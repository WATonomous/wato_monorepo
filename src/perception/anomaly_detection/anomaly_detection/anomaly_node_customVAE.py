...
import numpy as np
from anomaly_detection.vae_scratch import VAE

"""
assuming we'll be getting cropped object images directly from your object detection pipeline.
"""
...
class Anomaly(Node):
    ...
    def __init__(self):
        ...
        # --- VAE Specific Initializations ---
        self.device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
        self.get_logger().info(f"Anomaly Detection Node using device: {self.device}")
