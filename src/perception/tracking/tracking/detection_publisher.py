...
class TrackerNode(Node):
    ...
    def publish_first_detection_message(self):
        ...
        bbox1.center.orientation = Quaternion(x=0.0, y=0.0, z=0.7071, w=0.7071)  # Quaternion for yaw 90 degrees (π/2)
        ...
        bbox2.center.orientation = Quaternion(x=0.0, y=0.0, z=0.24740395925452294, w=0.9689124217106447)  # Quaternion for yaw 0.5
    ...
    def publish_second_detection_message(self):
        ...
        bbox.center.orientation = Quaternion(x=0.0, y=0.0, z=0.479425538604203, w=0.8775825618903728)  # Quaternion for yaw 1.0
