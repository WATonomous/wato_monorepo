...
bbox_2d_3d::bbox_2d_3d() : Node("bbox_2d_3d") {
  ...
  camera_info_sub_ = this->create_subscription<sensor_msgs::msg::CameraInfo>(
      ...
      std::bind(&bbox_2d_3d::cameraInfoCallback, this, std::placeholders::_1));
...
>>>>>>> 73d3754962427504470660d1df37af7e9ff50258
...
void bbox_2d_3d::detsCallback(const vision_msgs::msg::Detection2DArray::SharedPtr msg) {
  ...
  ProjectionUtils::computeHighestIOUCluster(filtered_point_cloud_, cluster_indices, *msg, transform,
                                            camInfo_->p, object_detection_confidence_);
