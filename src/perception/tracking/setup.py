...
with open (os.path.join('nusc_info', 'nuscenes_data_path.txt'), 'w') as f:
    f.write(os.path.join(os.path.dirname(os.path.abspath(__file__)), "tracking", "dataset_tracking", "nuscenes"))
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'nusc_info'), glob(os.path.join('nusc_info', '*.txt'))),
    ],
