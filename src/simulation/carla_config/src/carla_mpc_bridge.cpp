...
class MPC_Bridge_Node : public rclcpp::Node {
 ...
 public:
  MPC_Bridge_Node() : Node("carla_mpc_bridge") {
    ...
    rclcpp::Subscription<path_planning_msgs::msg::CarlaEgoVehicleStatus>::SharedPtr
        steeringAngleSub;
    ...
    this->steeringPub =
        this->create_publisher<embedded_msgs::msg::SteeringAngleCAN>(steering_publisher_topic, 1);
    this->carlaPub = this->create_publisher<path_planning_msgs::msg::AckermannDrive>(
