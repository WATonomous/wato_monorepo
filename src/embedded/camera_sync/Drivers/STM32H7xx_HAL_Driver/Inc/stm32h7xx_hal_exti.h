...
#define EXTI_D3_PENDCLR_SRC_DMACH6 \
  0x00000001U /*!< DMA ch6 event selected as D3 domain pendclear source, PMRx register to be set to 1 */
#define EXTI_D3_PENDCLR_SRC_DMACH7 \
  0x00000002U /*!< DMA ch7 event selected as D3 domain pendclear source, PMRx register to be set to 1*/
#if defined(LPTIM4)
  #define EXTI_D3_PENDCLR_SRC_LPTIM4 \
    0x00000003U /*!< LPTIM4 out selected as D3 domain pendclear source, PMRx register to be set to 1    */
#else
  #define EXTI_D3_PENDCLR_SRC_LPTIM2 \
    0x00000003U /*!< LPTIM2 out selected as D3 domain pendclear source, PMRx register to be set to 1    */
#endif
#if defined(LPTIM5)
  #define EXTI_D3_PENDCLR_SRC_LPTIM5 \
    0x00000004U /*!< LPTIM5 out selected as D3 domain pendclear source, PMRx register to be set to 1    */
#else
  #define EXTI_D3_PENDCLR_SRC_LPTIM3 \
    0x00000004U /*!< LPTIM3 out selected as D3 domain pendclear source, PMRx register to be set to 1    */
#endif
/**
  * @}
  */
...
/**
  ...
  */
  ...
  #define EXTI_MODE_MASK \
    (EXTI_MODE_CORE1_EVENT | EXTI_MODE_CORE1_INTERRUPT | EXTI_MODE_CORE2_INTERRUPT | EXTI_MODE_CORE2_EVENT)
#else
...
#define IS_EXTI_CONFIG_LINE(__EXTI_LINE__) (((__EXTI_LINE__) & EXTI_CONFIG) != 0x00UL)
  ...
  #define IS_EXTI_GPIO_PORT(__PORT__)                                                          \
    (((__PORT__) == EXTI_GPIOA) || ((__PORT__) == EXTI_GPIOB) || ((__PORT__) == EXTI_GPIOC) || \
     ((__PORT__) == EXTI_GPIOD) || ((__PORT__) == EXTI_GPIOE) || ((__PORT__) == EXTI_GPIOF) || \
     ((__PORT__) == EXTI_GPIOG) || ((__PORT__) == EXTI_GPIOH) || ((__PORT__) == EXTI_GPIOJ) || \
     ((__PORT__) == EXTI_GPIOK))
#endif /*GPIOI*/
...
#define IS_EXTI_GPIO_PIN(__PIN__) ((__PIN__) < 16UL)
  ...
  #define IS_EXTI_D3_PENDCLR_SRC(__SRC__)                                                      \
    (((__SRC__) == EXTI_D3_PENDCLR_SRC_NONE) || ((__SRC__) == EXTI_D3_PENDCLR_SRC_DMACH6) ||   \
     ((__SRC__) == EXTI_D3_PENDCLR_SRC_DMACH7) || ((__SRC__) == EXTI_D3_PENDCLR_SRC_LPTIM4) || \
     ((__SRC__) == EXTI_D3_PENDCLR_SRC_LPTIM5))
#else
  #define IS_EXTI_D3_PENDCLR_SRC(__SRC__)                                                      \
    (((__SRC__) == EXTI_D3_PENDCLR_SRC_NONE) || ((__SRC__) == EXTI_D3_PENDCLR_SRC_DMACH6) ||   \
     ((__SRC__) == EXTI_D3_PENDCLR_SRC_DMACH7) || ((__SRC__) == EXTI_D3_PENDCLR_SRC_LPTIM2) || \
