...
/** @defgroup RCCEx_SPI45_Clock_Source SPI4/5 Clock Source
  ...
  */
  ...
  #define RCC_SPI45CLKSOURCE_D2PCLK2 \
    RCC_SPI45CLKSOURCE_CDPCLK2 /* D2PCLK2 is used in STM32H74xxx, STM32H75xxx, STM32H72xxx and STM32H73xxx family lines */
...
/** @defgroup RCCEx_SPI6_Clock_Source SPI6 Clock Source
  ...
  */
  ...
  #define RCC_SPI6CLKSOURCE_D3PCLK1 \
    RCC_SPI6CLKSOURCE_SRDPCLK4 /* D3PCLK1 is used in STM32H74xxx, STM32H75xxx, STM32H72xxx and STM32H73xxx family lines */
...
#define RCC_CRS_SYNC_SOURCE_PIN \
  (0x00000000U) /*!< Synchro Signal source external pin, Available on STM32H7 Rev.B and above devices only */
...
#define __HAL_RCC_PLL2_CONFIG(__PLL2M__, __PLL2N__, __PLL2P__, __PLL2Q__, __PLL2R__)                        \
  do {                                                                                                      \
    ...
    WRITE_REG(                                                                                              \
      RCC->PLL2DIVR,                                                                                        \
      ((((__PLL2N__) - 1U) & RCC_PLL2DIVR_N2) | ((((__PLL2P__) - 1U) << 9U) & RCC_PLL2DIVR_P2) |            \
...
#define __HAL_RCC_PLL3_CONFIG(__PLL3M__, __PLL3N__, __PLL3P__, __PLL3Q__, __PLL3R__)                        \
  do {                                                                                                      \
    ...
    WRITE_REG(                                                                                              \
      RCC->PLL3DIVR,                                                                                        \
      ((((__PLL3N__) - 1U) & RCC_PLL3DIVR_N3) | ((((__PLL3P__) - 1U) << 9U) & RCC_PLL3DIVR_P3) |            \
...
#define __HAL_RCC_PLL3FRACN_CONFIG(__RCC_PLL3FRACN__) \
  MODIFY_REG(RCC->PLL3FRACR, RCC_PLL3FRACR_FRACN3, (uint32_t)(__RCC_PLL3FRACN__) << RCC_PLL3FRACR_FRACN3_Pos)
...
#define IS_RCC_PLL3CLOCKOUT_VALUE(VALUE) \
  ...
  #define IS_RCC_USART234578CLKSOURCE(SOURCE)                                                         \
    (((SOURCE) == RCC_USART234578CLKSOURCE_D2PCLK1) || ((SOURCE) == RCC_USART234578CLKSOURCE_PLL2) || \
     ((SOURCE) == RCC_USART234578CLKSOURCE_PLL3) || ((SOURCE) == RCC_USART234578CLKSOURCE_CSI) ||     \
     ((SOURCE) == RCC_USART234578CLKSOURCE_LSE) || ((SOURCE) == RCC_USART234578CLKSOURCE_HSI))
#else
  #define IS_RCC_USART234578CLKSOURCE(SOURCE)                                                            \
    (((SOURCE) == RCC_USART234578CLKSOURCE_D2PCLK1) || ((SOURCE) == RCC_USART234578CLKSOURCE_CDPCLK1) || \
     ((SOURCE) == RCC_USART234578CLKSOURCE_PLL2) || ((SOURCE) == RCC_USART234578CLKSOURCE_PLL3) ||       \
     ((SOURCE) == RCC_USART234578CLKSOURCE_CSI) || ((SOURCE) == RCC_USART234578CLKSOURCE_LSE) ||         \
...
#define IS_RCC_I2C4CLKSOURCE(SOURCE)                                              \
  (((SOURCE) == RCC_I2C4CLKSOURCE_PLL3) || ((SOURCE) == RCC_I2C4CLKSOURCE_HSI) || \
   ((SOURCE) == RCC_I2C4CLKSOURCE_D3PCLK1) || ((SOURCE) == RCC_I2C4CLKSOURCE_CSI))
...
#define IS_RCC_RNGCLKSOURCE(SOURCE)                                                                                    \
  (((SOURCE) == RCC_RNGCLKSOURCE_HSI48) || ((SOURCE) == RCC_RNGCLKSOURCE_PLL) || ((SOURCE) == RCC_RNGCLKSOURCE_LSE) || \
   ((SOURCE) == RCC_RNGCLKSOURCE_LSI))

#if defined(HRTIM1)
  #define IS_RCC_HRTIM1CLKSOURCE(SOURCE) (((SOURCE) == RCC_HRTIM1CLK_TIMCLK) || ((SOURCE) == RCC_HRTIM1CLK_CPUCLK))
#endif

#define IS_RCC_USBCLKSOURCE(SOURCE) \
  (((SOURCE) == RCC_USBCLKSOURCE_PLL) || ((SOURCE) == RCC_USBCLKSOURCE_PLL3) || ((SOURCE) == RCC_USBCLKSOURCE_HSI48))
...
#define IS_RCC_SAI1CLK(__SOURCE__)                                                         \
  ...
  #define IS_RCC_SAI23CLK(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_SAI23CLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI23CLKSOURCE_PLL2) ||  \
     ((__SOURCE__) == RCC_SAI23CLKSOURCE_PLL3) || ((__SOURCE__) == RCC_SAI23CLKSOURCE_CLKP) || \
  ...
  #define IS_RCC_SAI2ACLK(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_SAI2ACLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI2ACLKSOURCE_PLL2) ||  \
     ((__SOURCE__) == RCC_SAI2ACLKSOURCE_PLL3) || ((__SOURCE__) == RCC_SAI2ACLKSOURCE_CLKP) || \
     ((__SOURCE__) == RCC_SAI2ACLKSOURCE_PIN) || ((__SOURCE__) == RCC_SAI2ACLKSOURCE_SPDIF))
#endif
  ...
  #define IS_RCC_SAI2BCLK(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_SAI2BCLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI2BCLKSOURCE_PLL2) ||  \
     ...
     ((__SOURCE__) == RCC_SAI2BCLKSOURCE_PIN) || ((__SOURCE__) == RCC_SAI2BCLKSOURCE_SPDIF))
#endif

#define IS_RCC_SPI123CLK(__SOURCE__)                                                           \
  (((__SOURCE__) == RCC_SPI123CLKSOURCE_PLL) || ((__SOURCE__) == RCC_SPI123CLKSOURCE_PLL2) ||  \
   ((__SOURCE__) == RCC_SPI123CLKSOURCE_PLL3) || ((__SOURCE__) == RCC_SPI123CLKSOURCE_CLKP) || \
...
#define IS_RCC_SPI45CLK(__SOURCE__)                                                             \
  (((__SOURCE__) == RCC_SPI45CLKSOURCE_D2PCLK2) || ((__SOURCE__) == RCC_SPI45CLKSOURCE_PLL2) || \
...
#define IS_RCC_SPI4CLK(__SOURCE__)                                                            \
  (((__SOURCE__) == RCC_SPI4CLKSOURCE_D2PCLK2) || ((__SOURCE__) == RCC_SPI4CLKSOURCE_PLL2) || \
...
#define IS_RCC_SPI5CLK(__SOURCE__)                                                            \
  (((__SOURCE__) == RCC_SPI5CLKSOURCE_D2PCLK2) || ((__SOURCE__) == RCC_SPI5CLKSOURCE_PLL2) || \
  ...
  #define IS_RCC_SAI4ACLK(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_SAI4ACLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI4ACLKSOURCE_PLL2) ||  \
     ((__SOURCE__) == RCC_SAI4ACLKSOURCE_PLL3) || ((__SOURCE__) == RCC_SAI4ACLKSOURCE_CLKP) || \
  ...
  #define IS_RCC_SAI4BCLK(__SOURCE__)                                                          \
    (((__SOURCE__) == RCC_SAI4BCLKSOURCE_PLL) || ((__SOURCE__) == RCC_SAI4BCLKSOURCE_PLL2) ||  \
     ((__SOURCE__) == RCC_SAI4BCLKSOURCE_PLL3) || ((__SOURCE__) == RCC_SAI4BCLKSOURCE_CLKP) || \
...
#define IS_RCC_PLL2RGE_VALUE(VALUE)                                                                         \
  (((VALUE) == RCC_PLL2VCIRANGE_0) || ((VALUE) == RCC_PLL2VCIRANGE_1) || ((VALUE) == RCC_PLL2VCIRANGE_2) || \
   ((VALUE) == RCC_PLL2VCIRANGE_3))

#define IS_RCC_PLL3RGE_VALUE(VALUE)                                                                         \
  (((VALUE) == RCC_PLL3VCIRANGE_0) || ((VALUE) == RCC_PLL3VCIRANGE_1) || ((VALUE) == RCC_PLL3VCIRANGE_2) || \
   ((VALUE) == RCC_PLL3VCIRANGE_3))

#define IS_RCC_PLL2VCO_VALUE(VALUE) (((VALUE) == RCC_PLL2VCOWIDE) || ((VALUE) == RCC_PLL2VCOMEDIUM))

#define IS_RCC_PLL3VCO_VALUE(VALUE) (((VALUE) == RCC_PLL3VCOWIDE) || ((VALUE) == RCC_PLL3VCOMEDIUM))
...
#if defined(DSI)
  #define IS_RCC_DSICLK(__SOURCE__) (((__SOURCE__) == RCC_DSICLKSOURCE_PHY) || ((__SOURCE__) == RCC_DSICLKSOURCE_PLL2))
#endif /*DSI*/
...
#define IS_RCC_SDMMC(__SOURCE__) (((__SOURCE__) == RCC_SDMMCCLKSOURCE_PLL) || ((__SOURCE__) == RCC_SDMMCCLKSOURCE_PLL2))

#define IS_RCC_ADCCLKSOURCE(SOURCE) \
  (((SOURCE) == RCC_ADCCLKSOURCE_PLL2) || ((SOURCE) == RCC_ADCCLKSOURCE_PLL3) || ((SOURCE) == RCC_ADCCLKSOURCE_CLKP))
...
#define IS_RCC_CECCLKSOURCE(SOURCE) \
  (((SOURCE) == RCC_CECCLKSOURCE_LSE) || ((SOURCE) == RCC_CECCLKSOURCE_LSI) || ((SOURCE) == RCC_CECCLKSOURCE_CSI))
...
#define IS_RCC_CRS_SYNC_SOURCE(__SOURCE__)                                                    \
  (((__SOURCE__) == RCC_CRS_SYNC_SOURCE_USB2) || ((__SOURCE__) == RCC_CRS_SYNC_SOURCE_LSE) || \
   ((__SOURCE__) == RCC_CRS_SYNC_SOURCE_USB1) || ((__SOURCE__) == RCC_CRS_SYNC_SOURCE_PIN))
