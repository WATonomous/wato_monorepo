 ...
 */
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledStream(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_EN) ==
       (DMA_SxCR_EN))
        ? 1UL
        : 0UL);
  }
  ...
  __STATIC_INLINE void LL_DMA_ConfigTransfer(const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t Configuration)
  {
    ...
    MODIFY_REG(
      ...
      DMA_SxCR_DIR | DMA_SxCR_CIRC | DMA_SxCR_PINC | DMA_SxCR_MINC | DMA_SxCR_PSIZE | DMA_SxCR_MSIZE | DMA_SxCR_PL |
        DMA_SxCR_PFCTRL | DMA_SxCR_DBM | DMA_SxCR_CT,
      Configuration);
  }
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_GetMode(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (READ_BIT(
      ((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_CIRC | DMA_SxCR_PFCTRL));
  }
  ...
  */
  __STATIC_INLINE void LL_DMA_SetPeriphIncMode(const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t IncrementMode)
  {
    ...
    MODIFY_REG(
      ((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PINC, IncrementMode);
  }
  ...
  */
  __STATIC_INLINE void LL_DMA_SetMemoryIncMode(const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t IncrementMode)
  {
    ...
    MODIFY_REG(
      ((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_MINC, IncrementMode);
  }
  ...
  */
  __STATIC_INLINE void LL_DMA_SetIncOffsetSize(const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t OffsetSize)
  {
    ...
    MODIFY_REG(
      ((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_PINCOS, OffsetSize);
  }
  ...
  */
  ...
  {
    MODIFY_REG(
      ((DMAMUX_Channel_TypeDef *)(uint32_t)((uint32_t)DMAMUX1_Channel0 + (DMAMUX_CCR_SIZE * (Stream)) +
                                            (uint32_t)(DMAMUX_CCR_SIZE * LL_DMA_INSTANCE_TO_DMAMUX_CHANNEL(DMAx))))
        ->CCR,
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledDoubleBufferMode(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_DBM) ==
       (DMA_SxCR_DBM))
        ? 1UL
        : 0UL);
  }
  ...
  */
  __STATIC_INLINE void LL_DMA_ConfigFifo(
    const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t FifoMode, uint32_t FifoThreshold)
  {
    uint32_t dma_base_addr = (uint32_t)DMAx;
  ...
  */
  __STATIC_INLINE void LL_DMA_ConfigAddresses(
    const DMA_TypeDef * DMAx, uint32_t Stream, uint32_t SrcAddress, uint32_t DstAddress, uint32_t Direction)
  {
    uint32_t dma_base_addr = (uint32_t)DMAx;
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_HT(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_HTIE) ==
       DMA_SxCR_HTIE)
        ? 1UL
        : 0UL);
  }
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_TE(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_TEIE) ==
       DMA_SxCR_TEIE)
        ? 1UL
        : 0UL);
  }
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_TC(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_TCIE) ==
       DMA_SxCR_TCIE)
        ? 1UL
        : 0UL);
  }
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_DME(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->CR, DMA_SxCR_DMEIE) ==
       DMA_SxCR_DMEIE)
        ? 1UL
        : 0UL);
  }
  ...
  */
  __STATIC_INLINE uint32_t LL_DMA_IsEnabledIT_FE(const DMA_TypeDef * DMAx, uint32_t Stream)
  {
    ...
    return (
      (READ_BIT(((DMA_Stream_TypeDef *)(dma_base_addr + LL_DMA_STR_OFFSET_TAB[Stream]))->FCR, DMA_SxFCR_FEIE) ==
       DMA_SxFCR_FEIE)
        ? 1UL
        : 0UL);
  }
