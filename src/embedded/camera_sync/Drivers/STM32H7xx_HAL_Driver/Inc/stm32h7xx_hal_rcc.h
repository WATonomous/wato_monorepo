...
#define RCC_HSICALIBRATION_DEFAULT \
  (0x40U) /* Default HSI calibration trimming value for STM32H7 rev.V and above. (0x20 value for rev.Y handled within __HAL_RCC_HSI_CALIBRATIONVALUE_ADJUST macro ) */
/**
  * @}
  */
...
#define RCC_CSICALIBRATION_DEFAULT \
  (0x20U) /* Default CSI calibration trimming value for STM32H7 rev.V and above. (0x10 value for rev.Y handled within __HAL_RCC_CSI_CALIBRATIONVALUE_ADJUST macro ) */
/**
  * @}
  */
...
#define __HAL_RCC_RTC_IS_CLK_DISABLED() ((RCC->APB4ENR & RCC_APB4ENR_RTCAPBEN) == 0U)
  ...
  */
  ...
  #define __HAL_RCC_AHB3_FORCE_RESET() \
    (RCC->AHB3RSTR =                   \
       0x01E95031U) /* Resets MDMA, DMA2D, JPEG, FMC, OSPI1, SDMMC1, OSPI2, IOMNGR, OTFD1, OTFD2 and GFXMMU */
#else
  #define __HAL_RCC_AHB3_FORCE_RESET() \
    (RCC->AHB3RSTR = 0x00E95011U) /* Resets MDMA, DMA2D, FMC, OSPI1, SDMMC1, OSPI2, IOMNGR, OTFD1, OTFD2 */
...
/** @brief  Force or release the AHB1 peripheral reset.
  */
  ...
  #define __HAL_RCC_AHB1_FORCE_RESET() \
    (RCC->AHB1RSTR = 0x0A00C023U) /* Resets DMA1, DMA2, ADC12, ART, ETHMAC, USB1OTG and USB2OTG */
#elif (STM32H7_DEV_ID == 0x480UL)
...
/** @brief  Force or release the AHB2 peripheral reset.
  */
  ...
  #define __HAL_RCC_AHB2_FORCE_RESET() \
    (RCC->AHB2RSTR = 0x00000A75U) /* Resets DCMI_PSSI, HSEM, CRYPT, HASH, RNG, SDMMC2 and BDMA1 */
#else
  #define __HAL_RCC_AHB2_FORCE_RESET() \
    (RCC->AHB2RSTR = 0x00030271U) /* Resets DCMI_PSSI, CRYPT, HASH, RNG, SDMMC2, FMAC and CORDIC */
#endif /* STM32H7_DEV_ID == 0x450UL */
#if defined(DCMI) && defined(PSSI)
...
#define __HAL_RCC_SDMMC2_RELEASE_RESET() (RCC->AHB2RSTR &= ~(RCC_AHB2RSTR_SDMMC2RST))
  ...
  */
  ...
  #define __HAL_RCC_AHB4_FORCE_RESET() \
    (RCC->AHB4RSTR = 0x032806FFU) /* Resets GPIOA..GPIOH, GPIOJ, GPIOK, CRC, BDMA, ADC3 and HSEM */
#endif /* STM32H7_DEV_ID == 0x450UL */
...
/** @brief  Force or release the APB1 peripheral reset.
  */
  ...
  #define __HAL_RCC_APB1L_FORCE_RESET() \
    (RCC->APB1LRSTR =                   \
       0xE8FFC3FFU) /* Resets TIM2..TIM7, TIM12..TIM14, LPTIM1, SPI2, SPI3, SPDIFRX, USART2, USART3, UART4, UART5, I2C1..I2C3, CEC, DAC1(2), UART7 and UART8 */
#else
  #define __HAL_RCC_APB1L_FORCE_RESET() \
    (RCC->APB1LRSTR =                   \
       0xEAFFC3FFU) /* Resets TIM2..TIM7, TIM12..TIM14, LPTIM1, SPI2, SPI3, SPDIFRX, USART2, USART3, UART4, UART5, I2C1..I2C3, I2C5, CEC, DAC12, UART7 and UART8 */
#endif /* STM32H7_DEV_ID == 0x450UL */
#if (STM32H7_DEV_ID == 0x450UL) || (STM32H7_DEV_ID == 0x480UL)
...
/** @brief  Force or release the APB2 peripheral reset.
  */
  ...
  #define __HAL_RCC_APB2_FORCE_RESET() \
    (RCC->APB2RSTR =                   \
       0x31D73033U) /* Resets TIM1, TIM8, USART1, USART6, SPI1, SPI4, TIM15..TIM17, SPI5, SAI1..SAI3, DFSDM1 and HRTIM */
#elif (STM32H7_DEV_ID == 0x480UL)
  #define __HAL_RCC_APB2_FORCE_RESET() \
    (RCC->APB2RSTR =                   \
       0x40D730F3U) /* Resets TIM1, TIM8, USART1, USART6, UART9, USART10, SPI1, SPI4, TIM15..TIM17, SPI5, SAI1, SAI2 and DFSDM1 */
#else
  #define __HAL_RCC_APB2_FORCE_RESET() \
    (RCC->APB2RSTR =                   \
       0x405730F3U) /* Resets TIM1, TIM8, USART1, USART6, UART9, USART10, SPI1, SPI4, TIM15..TIM17, SPI5, SAI1 and DFSDM1 */
#endif /* STM32H7_DEV_ID == 0x450UL */
...
#define __HAL_RCC_DFSDM1_RELEASE_RESET() (RCC->APB2RSTR) &= ~(RCC_APB2RSTR_DFSDM1RST)
  ...
  */
  ...
  #define __HAL_RCC_APB4_FORCE_RESET() \
    (RCC->APB4RSTR = 0x0020DEAAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4, LPTIM2..LPTIM5, COMP12, VREF and SAI4 */
#elif (STM32H7_DEV_ID == 0x480UL)
  #define __HAL_RCC_APB4_FORCE_RESET() \
    (RCC->APB4RSTR =                   \
       0x0C00E6AAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4, LPTIM2, LPTIM3, DAC2, COMP12, VREF, DTS and DFSDM2 */
#else
  #define __HAL_RCC_APB4_FORCE_RESET() \
    (RCC->APB4RSTR = 0x0420DEAAU) /* Resets SYSCFG, LPUART1, SPI6, I2C4, LPTIM2..LPTIM5, COMP12, VREF, SAI4 and DTS */
#endif /* STM32H7_DEV_ID == 0x450UL */
...
#define __HAL_RCC_PLL_CONFIG(__RCC_PLLSOURCE__, __PLLM1__, __PLLN1__, __PLLP1__, __PLLQ1__, __PLLR1__)            \
  do {                                                                                                            \
    MODIFY_REG(                                                                                                   \
      RCC->PLLCKSELR, (RCC_PLLCKSELR_PLLSRC | RCC_PLLCKSELR_DIVM1), ((__RCC_PLLSOURCE__) | ((__PLLM1__) << 4U))); \
    WRITE_REG(                                                                                                    \
      RCC->PLL1DIVR,                                                                                              \
      ((((__PLLN1__) - 1U) & RCC_PLL1DIVR_N1) | ((((__PLLP1__) - 1U) << 9U) & RCC_PLL1DIVR_P1) |                  \
  ...
  #define __HAL_RCC_LSEDRIVE_CONFIG(__LSEDRIVE__)                                                    \
    do {                                                                                             \
      if (                                                                                           \
        ...
        (((__LSEDRIVE__) == RCC_LSEDRIVE_MEDIUMLOW) || ((__LSEDRIVE__) == RCC_LSEDRIVE_MEDIUMHIGH))) \
      {                                                                                              \
  ...
  */
  ...
  #define __HAL_RCC_GET_FLAG(__FLAG__)                                                                             \
    (((((((__FLAG__) >> 5U) == 1U)                                                                                 \
          ...
          : ((((__FLAG__) >> 5U) == 2U)                                                                            \
               ? RCC->BDCR                                                                                         \
               : ((((__FLAG__) >> 5U) == 3U) ? RCC->CSR : ((((__FLAG__) >> 5U) == 4U) ? RCC->RSR : RCC->CIFR)))) & \
  ...
  #define __HAL_RCC_C1_GET_FLAG(__FLAG__)                                                                             \
    (((((((__FLAG__) >> 5U) == 1U)                                                                                    \
          ...
          : ((((__FLAG__) >> 5U) == 2U)                                                                               \
               ? RCC->BDCR                                                                                            \
               : ((((__FLAG__) >> 5U) == 3U) ? RCC->CSR : ((((__FLAG__) >> 5U) == 4U) ? RCC_C1->RSR : RCC->CIFR)))) & \
       (1U << ((__FLAG__) & RCC_FLAG_MASK))) != 0U)                                                                   \
       ? 1U                                                                                                           \
       : 0U)
  ...
  #define __HAL_RCC_C2_GET_FLAG(__FLAG__)                                                                             \
    (((((((__FLAG__) >> 5U) == 1U)                                                                                    \
          ...
          : ((((__FLAG__) >> 5U) == 2U)                                                                               \
               ? RCC->BDCR                                                                                            \
               : ((((__FLAG__) >> 5U) == 3U) ? RCC->CSR : ((((__FLAG__) >> 5U) == 4U) ? RCC_C2->RSR : RCC->CIFR)))) & \
       (1U << ((__FLAG__) & RCC_FLAG_MASK))) != 0U)                                                                   \
       ? 1U                                                                                                           \
       : 0U)
...
#define IS_RCC_OSCILLATORTYPE(OSCILLATOR)                                                                              \
  (((OSCILLATOR) == RCC_OSCILLATORTYPE_NONE) || (((OSCILLATOR) & RCC_OSCILLATORTYPE_HSE) == RCC_OSCILLATORTYPE_HSE) || \
  ...
  #define IS_RCC_HSE(HSE) \
    (((HSE) == RCC_HSE_OFF) || ((HSE) == RCC_HSE_ON) || ((HSE) == RCC_HSE_BYPASS) || ((HSE) == RCC_HSE_BYPASS_DIGITAL))
#else
  ...
  #define IS_RCC_LSE(LSE) \
    (((LSE) == RCC_LSE_OFF) || ((LSE) == RCC_LSE_ON) || ((LSE) == RCC_LSE_BYPASS) || ((LSE) == RCC_LSE_BYPASS_DIGITAL))
#else
  #define IS_RCC_LSE(LSE) (((LSE) == RCC_LSE_OFF) || ((LSE) == RCC_LSE_ON) || ((LSE) == RCC_LSE_BYPASS))
#endif /* RCC_BDCR_LSEEXT */

#define IS_RCC_HSI(HSI)                                                                                     \
  (((HSI) == RCC_HSI_OFF) || ((HSI) == RCC_HSI_ON) || ((HSI) == RCC_HSI_DIV1) || ((HSI) == RCC_HSI_DIV2) || \
...
#define IS_RCC_PLLSOURCE(SOURCE)                                                                             \
  (((SOURCE) == RCC_PLLSOURCE_CSI) || ((SOURCE) == RCC_PLLSOURCE_HSI) || ((SOURCE) == RCC_PLLSOURCE_NONE) || \
   ((SOURCE) == RCC_PLLSOURCE_HSE))

#define IS_RCC_PLLRGE_VALUE(VALUE)                                                                          \
  (((VALUE) == RCC_PLL1VCIRANGE_0) || ((VALUE) == RCC_PLL1VCIRANGE_1) || ((VALUE) == RCC_PLL1VCIRANGE_2) || \
...
#define IS_RCC_SYSCLKSOURCE(SOURCE)                                                                                  \
  (((SOURCE) == RCC_SYSCLKSOURCE_CSI) || ((SOURCE) == RCC_SYSCLKSOURCE_HSI) || ((SOURCE) == RCC_SYSCLKSOURCE_HSE) || \
   ((SOURCE) == RCC_SYSCLKSOURCE_PLLCLK))

#define IS_RCC_SYSCLK(SYSCLK)                                                                           \
  (((SYSCLK) == RCC_SYSCLK_DIV1) || ((SYSCLK) == RCC_SYSCLK_DIV2) || ((SYSCLK) == RCC_SYSCLK_DIV4) ||   \
   ((SYSCLK) == RCC_SYSCLK_DIV8) || ((SYSCLK) == RCC_SYSCLK_DIV16) || ((SYSCLK) == RCC_SYSCLK_DIV64) || \
   ((SYSCLK) == RCC_SYSCLK_DIV128) || ((SYSCLK) == RCC_SYSCLK_DIV256) || ((SYSCLK) == RCC_SYSCLK_DIV512))

#define IS_RCC_HCLK(HCLK)                                                                                              \
  (((HCLK) == RCC_HCLK_DIV1) || ((HCLK) == RCC_HCLK_DIV2) || ((HCLK) == RCC_HCLK_DIV4) || ((HCLK) == RCC_HCLK_DIV8) || \
   ((HCLK) == RCC_HCLK_DIV16) || ((HCLK) == RCC_HCLK_DIV64) || ((HCLK) == RCC_HCLK_DIV128) ||                          \
   ((HCLK) == RCC_HCLK_DIV256) || ((HCLK) == RCC_HCLK_DIV512))

#define IS_RCC_CDPCLK1(CDPCLK1)                                                                    \
  (((CDPCLK1) == RCC_APB3_DIV1) || ((CDPCLK1) == RCC_APB3_DIV2) || ((CDPCLK1) == RCC_APB3_DIV4) || \
   ((CDPCLK1) == RCC_APB3_DIV8) || ((CDPCLK1) == RCC_APB3_DIV16))
...
#define IS_RCC_SRDPCLK1(SRDPCLK1)                                                                     \
  (((SRDPCLK1) == RCC_APB4_DIV1) || ((SRDPCLK1) == RCC_APB4_DIV2) || ((SRDPCLK1) == RCC_APB4_DIV4) || \
   ((SRDPCLK1) == RCC_APB4_DIV8) || ((SRDPCLK1) == RCC_APB4_DIV16))
...
#define IS_RCC_MCO1SOURCE(SOURCE)                                                                              \
  (((SOURCE) == RCC_MCO1SOURCE_HSI) || ((SOURCE) == RCC_MCO1SOURCE_LSE) || ((SOURCE) == RCC_MCO1SOURCE_HSE) || \
   ((SOURCE) == RCC_MCO1SOURCE_PLL1QCLK) || ((SOURCE) == RCC_MCO1SOURCE_HSI48))

#define IS_RCC_MCO2SOURCE(SOURCE)                                                                                      \
  (((SOURCE) == RCC_MCO2SOURCE_SYSCLK) || ((SOURCE) == RCC_MCO2SOURCE_PLL2PCLK) || ((SOURCE) == RCC_MCO2SOURCE_HSE) || \
   ((SOURCE) == RCC_MCO2SOURCE_PLLCLK) || ((SOURCE) == RCC_MCO2SOURCE_CSICLK) || ((SOURCE) == RCC_MCO2SOURCE_LSICLK))
...
#define IS_RCC_MCODIV(DIV)                                                                                        \
  ...
  #define IS_RCC_FLAG(FLAG)                                                                            \
    (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) || ((FLAG) == RCC_FLAG_HSI48RDY) ||    \
     ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_D1CKRDY) || ((FLAG) == RCC_FLAG_D2CKRDY) ||    \
     ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_PLL2RDY) || ((FLAG) == RCC_FLAG_PLL3RDY) ||    \
     ((FLAG) == RCC_FLAG_LSERDY) || ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_C1RST) ||       \
     ((FLAG) == RCC_FLAG_C2RST) || ((FLAG) == RCC_FLAG_SFTR2ST) || ((FLAG) == RCC_FLAG_WWDG2RST) ||    \
     ((FLAG) == RCC_FLAG_IWDG2RST) || ((FLAG) == RCC_FLAG_D1RST) || ((FLAG) == RCC_FLAG_D2RST) ||      \
     ((FLAG) == RCC_FLAG_BORRST) || ((FLAG) == RCC_FLAG_PINRST) || ((FLAG) == RCC_FLAG_PORRST) ||      \
     ((FLAG) == RCC_FLAG_SFTR1ST) || ((FLAG) == RCC_FLAG_IWDG1RST) || ((FLAG) == RCC_FLAG_WWDG1RST) || \
     ((FLAG) == RCC_FLAG_LPWR1RST) || ((FLAG) == RCC_FLAG_LPWR2RST) || ((FLAG) == RCC_FLAG_HSIDIV))
    ...
    #define IS_RCC_FLAG(FLAG)                                                                             \
      (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) || ((FLAG) == RCC_FLAG_HSI48RDY) ||     \
       ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_D1CKRDY) || ((FLAG) == RCC_FLAG_D2CKRDY) ||     \
       ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_PLL2RDY) || ((FLAG) == RCC_FLAG_PLL3RDY) ||     \
       ((FLAG) == RCC_FLAG_LSERDY) || ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_CPURST) ||       \
       ((FLAG) == RCC_FLAG_D1RST) || ((FLAG) == RCC_FLAG_D2RST) || ((FLAG) == RCC_FLAG_BORRST) ||         \
       ((FLAG) == RCC_FLAG_PINRST) || ((FLAG) == RCC_FLAG_PORRST) || ((FLAG) == RCC_FLAG_SFTRST) ||       \
       ((FLAG) == RCC_FLAG_IWDG1RST) || ((FLAG) == RCC_FLAG_WWDG1RST) || ((FLAG) == RCC_FLAG_LPWR1RST) || \
       ((FLAG) == RCC_FLAG_LPWR2RST) || ((FLAG) == RCC_FLAG_HSIDIV))
  #else
    #define IS_RCC_FLAG(FLAG)                                                                           \
      (((FLAG) == RCC_FLAG_HSIRDY) || ((FLAG) == RCC_FLAG_CSIRDY) || ((FLAG) == RCC_FLAG_HSI48RDY) ||   \
       ((FLAG) == RCC_FLAG_HSERDY) || ((FLAG) == RCC_FLAG_CPUCKRDY) || ((FLAG) == RCC_FLAG_CDCKRDY) ||  \
       ((FLAG) == RCC_FLAG_PLLRDY) || ((FLAG) == RCC_FLAG_PLL2RDY) || ((FLAG) == RCC_FLAG_PLL3RDY) ||   \
       ((FLAG) == RCC_FLAG_LSERDY) || ((FLAG) == RCC_FLAG_LSIRDY) || ((FLAG) == RCC_FLAG_CDRST) ||      \
       ((FLAG) == RCC_FLAG_BORRST) || ((FLAG) == RCC_FLAG_PINRST) || ((FLAG) == RCC_FLAG_PORRST) ||     \
       ((FLAG) == RCC_FLAG_SFTRST) || ((FLAG) == RCC_FLAG_IWDG1RST) || ((FLAG) == RCC_FLAG_WWDG1RST) || \
       ((FLAG) == RCC_FLAG_LPWR1RST) || ((FLAG) == RCC_FLAG_LPWR2RST) || ((FLAG) == RCC_FLAG_HSIDIV))
  #endif /* RCC_CR_D2CKRDY */
