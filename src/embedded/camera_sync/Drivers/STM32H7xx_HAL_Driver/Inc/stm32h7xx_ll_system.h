...
*/
  ...
  */
  #define LL_SYSCFG_TIMBREAK_AXISRAM_DBL_ECC \
    SYSCFG_CFGR_AXISRAML /*!< Enables and locks the AXIRAM double ECC error signal
  ...
  */
  ...
  #define LL_DBGMCU_APB1_GRP1_I2C1_STOP \
    DBGMCU_APB1LFZ1_DBG_I2C1 /*!< I2C1 SMBUS timeout mode stopped when Core is halted */
  #define LL_DBGMCU_APB1_GRP1_I2C2_STOP \
    DBGMCU_APB1LFZ1_DBG_I2C2 /*!< I2C2 SMBUS timeout mode stopped when Core is halted */
  #define LL_DBGMCU_APB1_GRP1_I2C3_STOP \
    DBGMCU_APB1LFZ1_DBG_I2C3 /*!< I2C3 SMBUS timeout mode stopped when Core is halted */
  #if defined(I2C5)
    #define LL_DBGMCU_APB1_GRP1_I2C5_STOP \
      DBGMCU_APB1LFZ1_DBG_I2C5 /*!< I2C5 SMBUS timeout mode stopped when Core is halted */
  #endif /*I2C5*/
  /**
  * @}
  */
  ...
  */
    ...
    #define LL_DBGMCU_APB1_GRP2_FDCAN_STOP \
      DBGMCU_APB1HFZ1_DBG_FDCAN /*!< FDCAN is frozen while the core is in debug mode */
  #endif /*DBGMCU_APB1HFZ1_DBG_FDCAN*/
  #if defined(TIM23)
    #define LL_DBGMCU_APB1_GRP2_TIM23_STOP \
      DBGMCU_APB1HFZ1_DBG_TIM23 /*!< TIM23 is frozen while the core is in debug mode */
  #endif /*TIM23*/
  #if defined(TIM24)
    #define LL_DBGMCU_APB1_GRP2_TIM24_STOP \
      DBGMCU_APB1HFZ1_DBG_TIM24 /*!< TIM24 is frozen while the core is in debug mode */
  #endif /*TIM24*/
  /**
  * @}
  */
  ...
  */
  #define LL_DBGMCU_APB3_GRP1_WWDG1_STOP \
    DBGMCU_APB3FZ1_DBG_WWDG1 /*!< WWDG1 is frozen while the core is in debug mode */
  /**
  * @}
  */
  ...
  */
  ...
  #define LL_DBGMCU_APB4_GRP1_LPTIM2_STOP \
    DBGMCU_APB4FZ1_DBG_LPTIM2 /*!< LPTIM2 is frozen while the core is in debug mode */
  #define LL_DBGMCU_APB4_GRP1_LPTIM3_STOP \
    DBGMCU_APB4FZ1_DBG_LPTIM3 /*!< LPTIM3 is frozen while the core is in debug mode */
  #define LL_DBGMCU_APB4_GRP1_LPTIM4_STOP \
    DBGMCU_APB4FZ1_DBG_LPTIM4 /*!< LPTIM4 is frozen while the core is in debug mode */
  #define LL_DBGMCU_APB4_GRP1_LPTIM5_STOP \
    DBGMCU_APB4FZ1_DBG_LPTIM5 /*!< LPTIM5 is frozen while the core is in debug mode */
  ...
  #define LL_DBGMCU_APB4_GRP1_IWDG1_STOP \
    DBGMCU_APB4FZ1_DBG_IWDG1 /*!< IWDG1 is frozen while the core is in debug mode */
  /**
  * @}
  */
  ...
  */
  __STATIC_INLINE void LL_SYSCFG_SetTIMBreakInputs(uint32_t Break)
  {
    ...
    MODIFY_REG(
      SYSCFG->CFGR,
      SYSCFG_CFGR_AXISRAML | SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_SRAM1L | SYSCFG_CFGR_SRAM2L |
    ...
    MODIFY_REG(
      SYSCFG->CFGR,
      SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_CM7L | SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL,
      Break);
  #endif /* DUAL_CORE */
  }
  ...
  */
  ...
  #else
    return (uint32_t)(READ_BIT(
      SYSCFG->CFGR, SYSCFG_CFGR_ITCML | SYSCFG_CFGR_DTCML | SYSCFG_CFGR_CM7L | SYSCFG_CFGR_FLASHL | SYSCFG_CFGR_PVDL));
  #endif /* DUAL_CORE */
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR0_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR1_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR2_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR3_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR4_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR5_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR6_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR5, SYSCFG_UR5_WRPN_BANK1) == (SYSCFG_UR5_WRPN_BANK1 & LL_SYSCFG_FLASH_B1_SECTOR7_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR0_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR1_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR2_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR3_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR4_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR5_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR6_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
  ...
  */
  ...
  {
    return (
      (READ_BIT(SYSCFG->UR9, SYSCFG_UR9_WRPN_BANK2) == (SYSCFG_UR9_WRPN_BANK2 & LL_SYSCFG_FLASH_B2_SECTOR7_STATUS_BIT))
        ? 1UL
        : 0UL);
  }
