...
#define IS_SYSCFG_ETHERNET_CONFIG(CONFIG) (((CONFIG) == SYSCFG_ETH_MII) || ((CONFIG) == SYSCFG_ETH_RMII))
...
#define IS_SYSCFG_ANALOG_SWITCH(SWITCH)                                                                              \
  ((((SWITCH) & SYSCFG_SWITCH_PA0) == SYSCFG_SWITCH_PA0) || (((SWITCH) & SYSCFG_SWITCH_PA1) == SYSCFG_SWITCH_PA1) || \
   (((SWITCH) & SYSCFG_SWITCH_PC2) == SYSCFG_SWITCH_PC2) || (((SWITCH) & SYSCFG_SWITCH_PC3) == SYSCFG_SWITCH_PC3))
...
#define IS_SYSCFG_BOOT_REGISTER(REGISTER) (((REGISTER) == SYSCFG_BOOT_ADDR0) || ((REGISTER) == SYSCFG_BOOT_ADDR1))
...
#define EXTI_LINE91 ((uint32_t)0x5B) /* Not available in all family lines */
  ...
  #define IS_HAL_EXTI_CONFIG_LINE(LINE)                                                                          \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE20) || ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE51) || \
     ((LINE) == EXTI_LINE82) || ((LINE) == EXTI_LINE84) || ((LINE) == EXTI_LINE85) || ((LINE) == EXTI_LINE86))
#else
  #define IS_HAL_EXTI_CONFIG_LINE(LINE)                                                                          \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ((LINE) == EXTI_LINE4) || ((LINE) == EXTI_LINE5) || ((LINE) == EXTI_LINE6) || ((LINE) == EXTI_LINE7) ||     \
  ...
  #define IS_EXTI_ALL_LINE(LINE)                                                                                 \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE28) || ((LINE) == EXTI_LINE29) || ((LINE) == EXTI_LINE30) || ((LINE) == EXTI_LINE31) || \
     ((LINE) == EXTI_LINE32) || ((LINE) == EXTI_LINE33) || ((LINE) == EXTI_LINE34) || ((LINE) == EXTI_LINE35) || \
     ((LINE) == EXTI_LINE36) || ((LINE) == EXTI_LINE37) || ((LINE) == EXTI_LINE38) || ((LINE) == EXTI_LINE39) || \
     ((LINE) == EXTI_LINE40) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE42) || ((LINE) == EXTI_LINE43) || \
     ((LINE) == EXTI_LINE44) || ((LINE) == EXTI_LINE46) || ((LINE) == EXTI_LINE47) || ((LINE) == EXTI_LINE48) || \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) || ((LINE) == EXTI_LINE52) || \
     ((LINE) == EXTI_LINE53) || ((LINE) == EXTI_LINE54) || ((LINE) == EXTI_LINE55) || ((LINE) == EXTI_LINE56) || \
     ((LINE) == EXTI_LINE57) || ((LINE) == EXTI_LINE58) || ((LINE) == EXTI_LINE59) || ((LINE) == EXTI_LINE60) || \
     ((LINE) == EXTI_LINE61) || ((LINE) == EXTI_LINE62) || ((LINE) == EXTI_LINE63) || ((LINE) == EXTI_LINE64) || \
     ((LINE) == EXTI_LINE65) || ((LINE) == EXTI_LINE66) || ((LINE) == EXTI_LINE67) || ((LINE) == EXTI_LINE68) || \
     ((LINE) == EXTI_LINE69) || ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) || \
     ((LINE) == EXTI_LINE73) || ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) || ((LINE) == EXTI_LINE76) || \
     ((LINE) == EXTI_LINE77) || ((LINE) == EXTI_LINE79) || ((LINE) == EXTI_LINE84) || ((LINE) == EXTI_LINE85) || \
     ((LINE) == EXTI_LINE86) || ((LINE) == EXTI_LINE87) || ((LINE) == EXTI_LINE78) || ((LINE) == EXTI_LINE80) || \
     ((LINE) == EXTI_LINE82))
#else
  #define IS_EXTI_ALL_LINE(LINE)                                                                                 \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE36) || ((LINE) == EXTI_LINE37) || ((LINE) == EXTI_LINE38) || ((LINE) == EXTI_LINE39) || \
     ((LINE) == EXTI_LINE40) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE42) || ((LINE) == EXTI_LINE43) || \
     ((LINE) == EXTI_LINE44) || ((LINE) == EXTI_LINE47) || ((LINE) == EXTI_LINE48) || ((LINE) == EXTI_LINE49) || \
     ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) || ((LINE) == EXTI_LINE52) || ((LINE) == EXTI_LINE53) || \
     ((LINE) == EXTI_LINE54) || ((LINE) == EXTI_LINE55) || ((LINE) == EXTI_LINE56) || ((LINE) == EXTI_LINE57) || \
     ((LINE) == EXTI_LINE58) || ((LINE) == EXTI_LINE59) || ((LINE) == EXTI_LINE60) || ((LINE) == EXTI_LINE61) || \
     ((LINE) == EXTI_LINE62) || ((LINE) == EXTI_LINE63) || ((LINE) == EXTI_LINE64) || ((LINE) == EXTI_LINE65) || \
     ((LINE) == EXTI_LINE66) || ((LINE) == EXTI_LINE67) || ((LINE) == EXTI_LINE68) || ((LINE) == EXTI_LINE69) || \
     ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) || ((LINE) == EXTI_LINE73) || \
     ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) || ((LINE) == EXTI_LINE76) || ((LINE) == EXTI_LINE85) || \
     ((LINE) == EXTI_LINE86) || ((LINE) == EXTI_LINE87) || ((LINE) == EXTI_LINE88) || ((LINE) == EXTI_LINE89) || \
  ...
  #define IS_EXTI_D2_LINE(LINE)                                                                                  \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE69) || ((LINE) == EXTI_LINE70) || ((LINE) == EXTI_LINE71) || ((LINE) == EXTI_LINE72) || \
     ((LINE) == EXTI_LINE73) || ((LINE) == EXTI_LINE74) || ((LINE) == EXTI_LINE75) || ((LINE) == EXTI_LINE76) || \
     ((LINE) == EXTI_LINE78) || ((LINE) == EXTI_LINE80) || ((LINE) == EXTI_LINE82) || ((LINE) == EXTI_LINE85) || \
     ((LINE) == EXTI_LINE86) || ((LINE) == EXTI_LINE87))
#endif /*DUAL_CORE*/
  ...
  #define IS_EXTI_D3_LINE(LINE)                                                                                  \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE8) || ((LINE) == EXTI_LINE9) || ((LINE) == EXTI_LINE10) || ((LINE) == EXTI_LINE11) ||   \
     ((LINE) == EXTI_LINE12) || ((LINE) == EXTI_LINE13) || ((LINE) == EXTI_LINE14) || ((LINE) == EXTI_LINE15) || \
     ((LINE) == EXTI_LINE19) || ((LINE) == EXTI_LINE20) || ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE25) || \
     ((LINE) == EXTI_LINE34) || ((LINE) == EXTI_LINE35) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE48) || \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) || ((LINE) == EXTI_LINE52) || \
     ((LINE) == EXTI_LINE53))
  ...
  #define IS_EXTI_D3_LINE(LINE)                                                                                  \
    (((LINE) == EXTI_LINE0) || ((LINE) == EXTI_LINE1) || ((LINE) == EXTI_LINE2) || ((LINE) == EXTI_LINE3) ||     \
     ...
     ((LINE) == EXTI_LINE19) || ((LINE) == EXTI_LINE20) || ((LINE) == EXTI_LINE21) || ((LINE) == EXTI_LINE25) || \
     ((LINE) == EXTI_LINE34) || ((LINE) == EXTI_LINE35) || ((LINE) == EXTI_LINE41) || ((LINE) == EXTI_LINE48) || \
     ((LINE) == EXTI_LINE49) || ((LINE) == EXTI_LINE50) || ((LINE) == EXTI_LINE51) || ((LINE) == EXTI_LINE88))
#endif /*DUAL_CORE*/
...
#define BDMA_CH7_CLEAR ((uint32_t)0x00000001) /*!< BDMA ch7 event selected as D3 domain pendclear source*/
  ...
  #define IS_EXTI_D3_CLEAR(SOURCE)                                                                     \
    (((SOURCE) == BDMA_CH6_CLEAR) || ((SOURCE) == BDMA_CH7_CLEAR) || ((SOURCE) == LPTIM4_OUT_CLEAR) || \
     ((SOURCE) == LPTIM5_OUT_CLEAR))
#else
  #define IS_EXTI_D3_CLEAR(SOURCE)                                                                     \
    (((SOURCE) == BDMA_CH6_CLEAR) || ((SOURCE) == BDMA_CH7_CLEAR) || ((SOURCE) == LPTIM2_OUT_CLEAR) || \
