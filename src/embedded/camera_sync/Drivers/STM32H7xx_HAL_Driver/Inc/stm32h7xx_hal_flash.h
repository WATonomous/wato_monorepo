...
#define FLASH_FLAG_CRCRDERR_BANK1 FLASH_SR_CRCRDERR /*!< CRC Read error on Bank 1 flag */
  ...
  #define FLASH_FLAG_ALL_ERRORS_BANK1                                                                         \
    (FLASH_FLAG_WRPERR_BANK1 | FLASH_FLAG_PGSERR_BANK1 | FLASH_FLAG_STRBERR_BANK1 | FLASH_FLAG_INCERR_BANK1 | \
     FLASH_FLAG_OPERR_BANK1 | FLASH_FLAG_RDPERR_BANK1 | FLASH_FLAG_RDSERR_BANK1 | FLASH_FLAG_SNECCERR_BANK1 | \
     FLASH_FLAG_DBECCERR_BANK1 | FLASH_FLAG_CRCRDERR_BANK1) /*!< All Bank 1 error flags */
#else
  #define FLASH_FLAG_ALL_ERRORS_BANK1                                                                            \
    (FLASH_FLAG_WRPERR_BANK1 | FLASH_FLAG_PGSERR_BANK1 | FLASH_FLAG_STRBERR_BANK1 | FLASH_FLAG_INCERR_BANK1 |    \
     FLASH_FLAG_RDPERR_BANK1 | FLASH_FLAG_RDSERR_BANK1 | FLASH_FLAG_SNECCERR_BANK1 | FLASH_FLAG_DBECCERR_BANK1 | \
     FLASH_FLAG_CRCRDERR_BANK1) /*!< All Bank 1 error flags */
#endif /* FLASH_SR_OPERR */

#define FLASH_FLAG_ALL_BANK1                                                                        \
  (FLASH_FLAG_BSY_BANK1 | FLASH_FLAG_WBNE_BANK1 | FLASH_FLAG_QW_BANK1 | FLASH_FLAG_CRC_BUSY_BANK1 | \
   FLASH_FLAG_EOP_BANK1 | FLASH_FLAG_CRCEND_BANK1 | FLASH_FLAG_ALL_ERRORS_BANK1) /*!< All Bank 1 flags */
...
#define FLASH_FLAG_CRCRDERR_BANK2 (FLASH_SR_CRCRDERR | 0x80000000U) /*!< CRC Read error on Bank 2 flag */
  ...
  #define FLASH_FLAG_ALL_ERRORS_BANK2                                                                         \
    (FLASH_FLAG_WRPERR_BANK2 | FLASH_FLAG_PGSERR_BANK2 | FLASH_FLAG_STRBERR_BANK2 | FLASH_FLAG_INCERR_BANK2 | \
     FLASH_FLAG_OPERR_BANK2 | FLASH_FLAG_RDPERR_BANK2 | FLASH_FLAG_RDSERR_BANK2 | FLASH_FLAG_SNECCERR_BANK2 | \
     FLASH_FLAG_DBECCERR_BANK2 | FLASH_FLAG_CRCRDERR_BANK2) /*!< All Bank 2 error flags */
#else
  #define FLASH_FLAG_ALL_ERRORS_BANK2                                                                            \
    (FLASH_FLAG_WRPERR_BANK2 | FLASH_FLAG_PGSERR_BANK2 | FLASH_FLAG_STRBERR_BANK2 | FLASH_FLAG_INCERR_BANK2 |    \
     FLASH_FLAG_RDPERR_BANK2 | FLASH_FLAG_RDSERR_BANK2 | FLASH_FLAG_SNECCERR_BANK2 | FLASH_FLAG_DBECCERR_BANK2 | \
     FLASH_FLAG_CRCRDERR_BANK2) /*!< All Bank 2 error flags */
#endif /* FLASH_SR_OPERR */

#define FLASH_FLAG_ALL_BANK2                                                                        \
  (FLASH_FLAG_BSY_BANK2 | FLASH_FLAG_WBNE_BANK2 | FLASH_FLAG_QW_BANK2 | FLASH_FLAG_CRC_BUSY_BANK2 | \
   FLASH_FLAG_EOP_BANK2 | FLASH_FLAG_CRCEND_BANK2 | FLASH_FLAG_ALL_ERRORS_BANK2) /*!< All Bank 2 flags */
/**
  * @}
  */
...
#define FLASH_IT_CRCRDERR_BANK1 FLASH_CR_CRCRDERRIE /*!< CRC Read error on Bank 1 Interrupt source */
  ...
  #define FLASH_IT_ALL_BANK1                                                                        \
    (FLASH_IT_EOP_BANK1 | FLASH_IT_WRPERR_BANK1 | FLASH_IT_PGSERR_BANK1 | FLASH_IT_STRBERR_BANK1 |  \
     FLASH_IT_INCERR_BANK1 | FLASH_IT_OPERR_BANK1 | FLASH_IT_RDPERR_BANK1 | FLASH_IT_RDSERR_BANK1 | \
     FLASH_IT_SNECCERR_BANK1 | FLASH_IT_DBECCERR_BANK1 | FLASH_IT_CRCEND_BANK1 |                    \
     FLASH_IT_CRCRDERR_BANK1) /*!< All Bank 1 Interrupt sources */
#else
  #define FLASH_IT_ALL_BANK1                                                                           \
    (FLASH_IT_EOP_BANK1 | FLASH_IT_WRPERR_BANK1 | FLASH_IT_PGSERR_BANK1 | FLASH_IT_STRBERR_BANK1 |     \
     FLASH_IT_INCERR_BANK1 | FLASH_IT_RDPERR_BANK1 | FLASH_IT_RDSERR_BANK1 | FLASH_IT_SNECCERR_BANK1 | \
     FLASH_IT_DBECCERR_BANK1 | FLASH_IT_CRCEND_BANK1 | FLASH_IT_CRCRDERR_BANK1) /*!< All Bank 1 Interrupt sources */
#endif /* FLASH_CR_OPERRIE */
...
#define FLASH_IT_SNECCERR_BANK2 \
  (FLASH_CR_SNECCERRIE | 0x80000000U) /*!< Single ECC Error Correction on Bank 2 Interrupt source */
#define FLASH_IT_DBECCERR_BANK2 \
  (FLASH_CR_DBECCERRIE | 0x80000000U) /*!< Double Detection ECC Error on Bank 2 Interrupt source */
...
#define FLASH_IT_CRCRDERR_BANK2 (FLASH_CR_CRCRDERRIE | 0x80000000U) /*!< CRC Read Error on Bank 2 Interrupt source */
  ...
  #define FLASH_IT_ALL_BANK2                                                                        \
    (FLASH_IT_EOP_BANK2 | FLASH_IT_WRPERR_BANK2 | FLASH_IT_PGSERR_BANK2 | FLASH_IT_STRBERR_BANK2 |  \
     FLASH_IT_INCERR_BANK2 | FLASH_IT_OPERR_BANK2 | FLASH_IT_RDPERR_BANK2 | FLASH_IT_RDSERR_BANK2 | \
     FLASH_IT_SNECCERR_BANK2 | FLASH_IT_DBECCERR_BANK2 | FLASH_IT_CRCEND_BANK2 |                    \
     FLASH_IT_CRCRDERR_BANK2) /*!< All Bank 2 Interrupt sources */
#else
  #define FLASH_IT_ALL_BANK2                                                                           \
    (FLASH_IT_EOP_BANK2 | FLASH_IT_WRPERR_BANK2 | FLASH_IT_PGSERR_BANK2 | FLASH_IT_STRBERR_BANK2 |     \
     FLASH_IT_INCERR_BANK2 | FLASH_IT_RDPERR_BANK2 | FLASH_IT_RDSERR_BANK2 | FLASH_IT_SNECCERR_BANK2 | \
     FLASH_IT_DBECCERR_BANK2 | FLASH_IT_CRCEND_BANK2 | FLASH_IT_CRCRDERR_BANK2) /*!< All Bank 2 Interrupt sources */
#endif /* FLASH_CR_OPERRIE */
  /**
  * @}
  */
...
#define __HAL_FLASH_GET_FLAG_BANK2(__FLAG__) \
  ...
  #define __HAL_FLASH_GET_FLAG(__FLAG__) \
    (IS_FLASH_FLAG_BANK1(__FLAG__) ? __HAL_FLASH_GET_FLAG_BANK1(__FLAG__) : __HAL_FLASH_GET_FLAG_BANK2(__FLAG__))
#else
...
#define __HAL_FLASH_CLEAR_FLAG_BANK2(__FLAG__) WRITE_REG(FLASH->CCR2, ((__FLAG__) & 0x7FFFFFFFU))
  ...
  #define __HAL_FLASH_CLEAR_FLAG(__FLAG__) \
    (IS_FLASH_FLAG_BANK1(__FLAG__) ? __HAL_FLASH_CLEAR_FLAG_BANK1(__FLAG__) : __HAL_FLASH_CLEAR_FLAG_BANK2(__FLAG__))
#else
