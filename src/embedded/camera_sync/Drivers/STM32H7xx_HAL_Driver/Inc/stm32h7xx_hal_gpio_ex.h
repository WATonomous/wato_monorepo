...
#define GPIO_AF0_TRACE \
  ...
  #define GPIO_AF0_C1DSLEEP \
    ((uint8_t)0x00) /* Cortex-M7 Deep Sleep Alternate Function mapping : available on STM32H7 Rev.B and above  */
  #define GPIO_AF0_C1SLEEP \
    ((uint8_t)0x00) /* Cortex-M7 Sleep Alternate Function mapping : available on STM32H7 Rev.B and above       */
  #define GPIO_AF0_D1PWREN \
    ((uint8_t)0x00) /* Domain 1 PWR enable Alternate Function mapping : available on STM32H7 Rev.B and above   */
  #define GPIO_AF0_D2PWREN \
    ((uint8_t)0x00) /* Domain 2 PWR enable Alternate Function mapping : available on STM32H7 Rev.B and above   */
  #if defined(DUAL_CORE)
    #define GPIO_AF0_C2DSLEEP \
      ((uint8_t)0x00) /* Cortex-M4 Deep Sleep Alternate Function mapping : available on STM32H7 Rev.B and above  */
    #define GPIO_AF0_C2SLEEP \
      ((uint8_t)0x00) /* Cortex-M4 Sleep Alternate Function mapping : available on STM32H7 Rev.B and above       */
  #endif /* DUAL_CORE */
...
#define GPIO_AF4_USART1 ((uint8_t)0x04) /* USART1 Alternate Function mapping */
  ...
  #define GPIO_AF4_USART10 \
    ((uint8_t)0x04) /* USART10 Alternate Function mapping : available on STM32H72xxx/STM32H73xxx */
#endif /*USART10*/
...
#define GPIO_AF4_DCMI \
  ...
  #define GPIO_AF4_OCTOSPIM_P1 \
    ((uint8_t)0x04) /* OCTOSPI Manager Port 1 Alternate Function mapping  : available on STM32H72xxx/STM32H73xxx */
#endif /* OCTOSPIM */
...
#define GPIO_AF10_CRS_SYNC \
  ((uint8_t)0x0A) /* CRS Sync Alternate Function mapping : available on STM32H7 Rev.B and above  */
#if defined(QUADSPI)
  ...
  #define GPIO_AF10_OTG1_FS \
    ((uint8_t)0x0A) /* OTG1_FS Alternate Function mapping : available on STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and STM32H72xxx/STM32H73xxx */
#endif /* !USB2_OTG_FS */
...
#define GPIO_AF10_FMC \
  ((uint8_t)0x0A) /* FMC Alternate Function mapping : available on STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and STM32H72xxx/STM32H73xxx */
...
#define GPIO_AF11_I2C4 ((uint8_t)0x0B) /* I2C4 Alternate Function mapping    */
  ...
  #define GPIO_AF11_LTDC \
    ((uint8_t)0x0B) /* LTDC Alternate Function mapping : available on STM32H7A3xxx/STM32H7B3xxx/STM32H7B0xxx and STM32H72xxx/STM32H73xxx */
#endif /*LTDC*/
#if defined(OCTOSPIM)
