...
#define OPTIONBYTE_SECURE_AREA 0x20U /*!< secure area option byte configuration */
  ...
  #define OPTIONBYTE_ALL                                                                                              \
    (OPTIONBYTE_WRP | OPTIONBYTE_RDP | OPTIONBYTE_USER | OPTIONBYTE_PCROP | OPTIONBYTE_BOR | OPTIONBYTE_SECURE_AREA | \
...
#if defined(DUAL_CORE)
  #define OB_USER_ALL                                                                                                \
    (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY |      \
     OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_SWAP_BANK | OB_USER_IWDG2_SW | OB_USER_BCM4 | \
     OB_USER_BCM7 | OB_USER_NRST_STOP_D2 | OB_USER_NRST_STDBY_D2)
#elif defined(FLASH_OPTSR_VDDMMC_HSLV)
  #if defined(DUAL_BANK)
    #define OB_USER_ALL                                                                                           \
      (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | \
       OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_SWAP_BANK | OB_USER_VDDMMC_HSLV)
  #else
    #define OB_USER_ALL                                                                                           \
      (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | \
       OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_VDDMMC_HSLV)
  #endif /* DUAL_BANK */
#elif defined(FLASH_OPTSR2_TCM_AXI_SHARED)
  #define OB_USER_ALL                                                                                           \
    (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | \
     OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_NRST_STOP_D2 | OB_USER_NRST_STDBY_D2)
#else /* Single core */
  #if defined(DUAL_BANK)
    #define OB_USER_ALL                                                                                           \
      (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | \
       OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV | OB_USER_SWAP_BANK)
  #else
    #define OB_USER_ALL                                                                                           \
      (OB_USER_IWDG1_SW | OB_USER_NRST_STOP_D1 | OB_USER_NRST_STDBY_D1 | OB_USER_IWDG_STOP | OB_USER_IWDG_STDBY | \
       OB_USER_ST_RAM_SIZE | OB_USER_SECURITY | OB_USER_IOHSLV)
  #endif /* DUAL_BANK */
#endif /* DUAL_CORE */
/**
  * @}
...
#define FLASH_PROGRAMMING_DELAY_1 \
  FLASH_ACR_WRHIGHFREQ_0 /*!< programming delay set for Flash running between 70 MHz and 185 MHz  */
#define FLASH_PROGRAMMING_DELAY_2 \
  FLASH_ACR_WRHIGHFREQ_1 /*!< programming delay set for Flash running between 185 MHz and 225 MHz */
...
#define __HAL_FLASH_CALC_BOOT_BASE_ADR(__ADDRESS__) ((__ADDRESS__) >> 14U)
  ...
  */
    ...
    #define __HAL_FLASH_GET_PSIZE(__BANK__) \
      (((__BANK__) == FLASH_BANK_1) ? READ_BIT((FLASH->CR1), FLASH_CR_PSIZE) : READ_BIT((FLASH->CR2), FLASH_CR_PSIZE))
  #else
...
#define IS_OB_PCROP_RDP(CONFIG) (((CONFIG) == OB_PCROP_RDP_NOT_ERASE) || ((CONFIG) == OB_PCROP_RDP_ERASE))

#define IS_OB_SECURE_RDP(CONFIG) (((CONFIG) == OB_SECURE_RDP_NOT_ERASE) || ((CONFIG) == OB_SECURE_RDP_ERASE))
...
#define IS_OB_USER_ST_RAM_SIZE(VALUE)                                                                       \
  (((VALUE) == OB_ST_RAM_SIZE_2KB) || ((VALUE) == OB_ST_RAM_SIZE_4KB) || ((VALUE) == OB_ST_RAM_SIZE_8KB) || \
