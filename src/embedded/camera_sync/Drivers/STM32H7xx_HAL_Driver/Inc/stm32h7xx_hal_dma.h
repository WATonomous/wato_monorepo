...
#define DMA_DOUBLE_BUFFER_M1 \
  ((uint32_t)(DMA_SxCR_DBM | DMA_SxCR_CT)) /*!< Double buffer mode with first target memory M1 */
/**
  * @}
  */
...
#define DMA_TO_BDMA_IT(__DMA_IT__)                                                                           \
  ((((__DMA_IT__) & (DMA_IT_TC | DMA_IT_HT | DMA_IT_TE)) == (DMA_IT_TC | DMA_IT_HT | DMA_IT_TE))             \
...
#define __HAL_DMA_STREAM_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                               \
  (((__INTERRUPT__) != DMA_IT_FE) ? (((DMA_Stream_TypeDef *)(__HANDLE__)->Instance)->CR |= (__INTERRUPT__)) \
...
#define __HAL_DMA_ENABLE_IT(__HANDLE__, __INTERRUPT__)                                                            \
  ((IS_DMA_STREAM_INSTANCE((__HANDLE__)->Instance)) ? (__HAL_DMA_STREAM_ENABLE_IT((__HANDLE__), (__INTERRUPT__))) \
...
#define __HAL_DMA_DISABLE_IT(__HANDLE__, __INTERRUPT__)                                                            \
  ((IS_DMA_STREAM_INSTANCE((__HANDLE__)->Instance)) ? (__HAL_DMA_STREAM_DISABLE_IT((__HANDLE__), (__INTERRUPT__))) \
...
#define __HAL_DMA_GET_COUNTER(__HANDLE__)                                                                    \
  ((IS_DMA_STREAM_INSTANCE((__HANDLE__)->Instance)) ? (((DMA_Stream_TypeDef *)(__HANDLE__)->Instance)->NDTR) \
...
#define IS_DMA_MODE(MODE)                                                                                              \
  (((MODE) == DMA_NORMAL) || ((MODE) == DMA_CIRCULAR) || ((MODE) == DMA_PFCTRL) || ((MODE) == DMA_DOUBLE_BUFFER_M0) || \
