...
#include "stm32h7xx.h"
  ...
  */
  ...
  #define LL_PWR_FLAG_ACTVOSRDY \
    PWR_CSR1_ACTVOSRDY /*!< Ready bit for current actual used VOS for VCORE voltage scaling flag */
  ...
  */
    ...
    #define LL_PWR_CPU_MODE_D1STANDBY \
      PWR_CPUCR_PDDS_D1 /*!< Enter D1 domain to Standby mode when the CPU enters deepsleep    */
  #else
    ...
    #define LL_PWR_CPU_MODE_CDSTOP2 \
      PWR_CPUCR_RETDS_CD /*!< Enter CD domain to Stop2 mode when the CPU enters deepsleep      */
  #endif /* PWR_CPUCR_PDDS_D2 */
    ...
    #define LL_PWR_CPU_MODE_D2STANDBY \
      PWR_CPUCR_PDDS_D2 /*!< Enter D2 domain to Standby mode when the CPU enters deepsleep    */
  #endif /* PWR_CPUCR_PDDS_D2 */

  #if defined(PWR_CPUCR_PDDS_D2)
    #define LL_PWR_CPU_MODE_D3RUN \
      PWR_CPUCR_RUN_D3 /*!< Keep system D3 domain in Run mode when the CPU enter deepsleep   */
    ...
    #define LL_PWR_CPU_MODE_D3STANDBY \
      PWR_CPUCR_PDDS_D3 /*!< Enter D3 domain to Standby mode when the CPU enters deepsleep    */
  #else
    #define LL_PWR_CPU_MODE_SRDRUN \
      PWR_CPUCR_RUN_SRD /*!< Keep system SRD domain in Run mode when the CPU enter deepsleep  */
    ...
    #define LL_PWR_CPU_MODE_SRDSTANDBY \
      PWR_CPUCR_PDDS_SRD /*!< Enter SRD domain to Standby mode when the CPU enters deepsleep   */
  #endif /* PWR_CPUCR_PDDS_D2 */
    ...
    #define LL_PWR_CPU2_MODE_D1STANDBY \
      PWR_CPU2CR_PDDS_D1 /*!< Enter D1 domain to Standby mode when the CPU2 enters deepsleep   */
    ...
    #define LL_PWR_CPU2_MODE_D2STANDBY \
      PWR_CPU2CR_PDDS_D2 /*!< Enter D2 domain to Standby mode when the CPU2 enters deepsleep   */
    #define LL_PWR_CPU2_MODE_D3RUN \
      PWR_CPU2CR_RUN_D3 /*!< Keep system D3 domain in RUN mode when the CPU2 enter deepsleep  */
    ...
    #define LL_PWR_CPU2_MODE_D3STANDBY \
      PWR_CPU2CR_PDDS_D3 /*!< Enter D3 domain to Standby mode when the CPU2 enter deepsleep    */
  #endif /* DUAL_CORE */
  /**
  * @}
  */
  ...
  */
  ...
  #define LL_PWR_REGU_VOLTAGE_SVOS_SCALE3 \
    (PWR_CR1_SVOS_0 | PWR_CR1_SVOS_1) /*!< Select voltage scale 3 when system enters STOP mode */
  /**
  * @}
  */
  ...
  */
  ...
  #define LL_PWR_PVDLEVEL_7 \
    PWR_CR1_PLS_LEV7 /*!< External voltage level on PVD_IN pin, compared to internal VREFINT level. */
  /**
  * @}
  */
  ...
  #define LL_PWR_LDO_SUPPLY \
    ...
    #define LL_PWR_SMPS_1V8_SUPPLIES_LDO      \
      (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEN | \
       PWR_CR3_LDOEN) /*!< The SMPS 1.8V output supplies the LDO which supplies the Core domains                                       */
    #define LL_PWR_SMPS_2V5_SUPPLIES_LDO      \
      (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEN | \
       PWR_CR3_LDOEN) /*!< The SMPS 2.5V output supplies the LDO which supplies the Core domains                                       */
    #define LL_PWR_SMPS_1V8_SUPPLIES_EXT_AND_LDO                  \
      (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN | \
       PWR_CR3_LDOEN) /*!< The SMPS 1.8V output supplies an external circuits and the LDO. The Core domains are supplied from the LDO */
    #define LL_PWR_SMPS_2V5_SUPPLIES_EXT_AND_LDO                  \
      (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN | \
       PWR_CR3_LDOEN) /*!< The SMPS 2.5V output supplies an external circuits and the LDO. The Core domains are supplied from the LDO */
    #define LL_PWR_SMPS_1V8_SUPPLIES_EXT                          \
      (PWR_CR3_SMPSLEVEL_0 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN | \
       PWR_CR3_BYPASS) /*!< The SMPS 1.8V output supplies an external source which supplies the Core domains                            */
    #define LL_PWR_SMPS_2V5_SUPPLIES_EXT                          \
      (PWR_CR3_SMPSLEVEL_1 | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN | \
       PWR_CR3_BYPASS) /*!< The SMPS 2.5V output supplies an external source which supplies the Core domains                            */
  #endif /* SMPS */
  #define LL_PWR_EXTERNAL_SOURCE_SUPPLY \
    PWR_CR3_BYPASS /*!< The SMPS and the LDO are Bypassed. The Core domains are supplied from an external source                    */
  /**
  * @}
  */
  ...
  */
  __STATIC_INLINE uint32_t LL_PWR_GetSupply(void)
  {
    ...
    return (uint32_t)(READ_BIT(
      PWR->CR3, (PWR_CR3_SMPSLEVEL | PWR_CR3_SMPSEXTHP | PWR_CR3_SMPSEN | PWR_CR3_LDOEN | PWR_CR3_BYPASS)));
  }
  #else
  /**
  * @brief  Get the PWR supply
  ...
  */
  ...
  {
    return (
      (READ_BIT(PWR->WKUPEPR, (WakeUpPin << PWR_WKUPEPR_WKUPP1_Pos)) == (WakeUpPin << PWR_WKUPEPR_WKUPP1_Pos)) ? 1UL
                                                                                                               : 0UL);
  }
  ...
  __STATIC_INLINE void LL_PWR_SetWakeUpPinPullNone(uint32_t WakeUpPin)
  {
    MODIFY_REG(
      ...
      (PWR_WKUPEPR_WKUPPUPD1
       << ((LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin)) & LL_PWR_WAKEUP_PINS_MAX_SHIFT_MASK)),
      (LL_PWR_WAKEUP_PIN_NOPULL
       << ((PWR_WKUPEPR_WKUPPUPD1_Pos + (LL_PWR_WAKEUP_PINS_PULL_SHIFT_OFFSET * POSITION_VAL(WakeUpPin))) &
