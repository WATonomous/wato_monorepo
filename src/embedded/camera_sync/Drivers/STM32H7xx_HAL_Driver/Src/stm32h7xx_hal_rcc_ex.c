...
void HAL_RCCEx_GetPeriphCLKConfig(RCC_PeriphCLKInitTypeDef * PeriphClkInit)
{
  ...
  PeriphClkInit->PeriphClockSelection =
    ...
    RCC_PERIPHCLK_LPTIM1 | RCC_PERIPHCLK_LPTIM2 | RCC_PERIPHCLK_LPTIM345 | RCC_PERIPHCLK_SAI1 | RCC_PERIPHCLK_SPI123 |
    RCC_PERIPHCLK_SPI45 | RCC_PERIPHCLK_SPI6 | RCC_PERIPHCLK_FDCAN | RCC_PERIPHCLK_SDMMC | RCC_PERIPHCLK_RNG |
    RCC_PERIPHCLK_USB | RCC_PERIPHCLK_ADC | RCC_PERIPHCLK_SWPMI1 | RCC_PERIPHCLK_DFSDM1 | RCC_PERIPHCLK_RTC |
    RCC_PERIPHCLK_CEC | RCC_PERIPHCLK_FMC | RCC_PERIPHCLK_SPDIFRX | RCC_PERIPHCLK_TIM | RCC_PERIPHCLK_CKPER;
...
uint32_t HAL_RCCEx_GetD1PCLK1Freq(void)
{
  ...
  return (
    HAL_RCC_GetHCLKFreq() >> (D1CorePrescTable[(RCC->D1CFGR & RCC_D1CFGR_D1PPRE) >> RCC_D1CFGR_D1PPRE_Pos] & 0x1FU));
  #else
  /* Get HCLK source and Compute D1PCLK1 frequency ---------------------------*/
  return (
    HAL_RCC_GetHCLKFreq() >> (D1CorePrescTable[(RCC->CDCFGR1 & RCC_CDCFGR1_CDPPRE) >> RCC_CDCFGR1_CDPPRE_Pos] & 0x1FU));
  #endif
}
...
uint32_t HAL_RCCEx_GetD3PCLK1Freq(void)
{
  ...
  return (
    HAL_RCC_GetHCLKFreq() >> (D1CorePrescTable[(RCC->D3CFGR & RCC_D3CFGR_D3PPRE) >> RCC_D3CFGR_D3PPRE_Pos] & 0x1FU));
  #else
  /* Get HCLK source and Compute D3PCLK1 frequency ---------------------------*/
  return (
    HAL_RCC_GetHCLKFreq() >>
    (D1CorePrescTable[(RCC->SRDCFGR & RCC_SRDCFGR_SRDPPRE) >> RCC_SRDCFGR_SRDPPRE_Pos] & 0x1FU));
  #endif
}
      ...
      case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
        ...
        if (__HAL_RCC_GET_FLAG(RCC_FLAG_HSIDIV) != 0U) {
          ...
          pll2vco = ((float_t)hsivalue / (float_t)pll2m) *
                    ((float_t)(uint32_t)(RCC->PLL2DIVR & RCC_PLL2DIVR_N2) + (fracn2 / (float_t)0x2000) + (float_t)1);
        } else {
      ...
      case RCC_PLLSOURCE_HSI: /* HSI used as PLL clock source */
        ...
        if (__HAL_RCC_GET_FLAG(RCC_FLAG_HSIDIV) != 0U) {
          ...
          pll3vco = ((float_t)hsivalue / (float_t)pll3m) *
                    ((float_t)(uint32_t)(RCC->PLL3DIVR & RCC_PLL3DIVR_N3) + (fracn3 / (float_t)0x2000) + (float_t)1);
        } else {
...
uint32_t HAL_RCCEx_GetD1SysClockFreq(void)
{
  ...
  common_system_clock =
    HAL_RCC_GetSysClockFreq() >> (D1CorePrescTable[(RCC->D1CFGR & RCC_D1CFGR_D1CPRE) >> RCC_D1CFGR_D1CPRE_Pos] & 0x1FU);
  #else
