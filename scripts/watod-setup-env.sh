...
CAMERA_SEGMENTATION_IMAGE=${CAMERA_SEGMENTATION_IMAGE:-"git.uwaterloo.ca:5050/watonomous/wato_monorepo/camera_segmentation"}
## -------------------------- User ID -----------------------------
...
echo "CAMERA_SEGMENTATION_IMAGE=$CAMERA_SEGMENTATION_IMAGE" >> "$PROFILES_DIR/.env"
