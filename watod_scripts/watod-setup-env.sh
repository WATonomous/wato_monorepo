...
WORLD_MODELING_BEHAVIOUR_TREE_IMAGE=${WORLD_MODELING_BEHAVIOUR_TREE_IMAGE:-"$REGISTRY_URL/world_modeling/behaviour_tree"}
...
echo "WORLD_MODELING_BEHAVIOUR_TREE_IMAGE=$WORLD_MODELING_BEHAVIOUR_TREE_IMAGE" >> "$MODULES_DIR/.env"
