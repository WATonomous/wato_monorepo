...
# Perception
PERCEPTION_ANOMALY_DETECTION_IMAGE=${PERCEPTION_ANOMALY_DETECTION_IMAGE:-"$REGISTRY_URL/perception/anomaly_detection"}
...
# Perception
echo "PERCEPTION_ANOMALY_DETECTION_IMAGE=$PERCEPTION_ANOMALY_DETECTION_IMAGE" >> "$MODULES_DIR/.env"
