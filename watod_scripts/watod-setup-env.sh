...
WORLD_MODELING_BEHAVIOUR_IMAGE=${WORLD_MODELING_BEHAVIOUR_IMAGE:-"$REGISTRY_URL/world_modeling/behaviour"}
...
echo "WORLD_MODELING_BEHAVIOUR_IMAGE=$WORLD_MODELING_BEHAVIOUR_IMAGE" >> "$MODULES_DIR/.env"
