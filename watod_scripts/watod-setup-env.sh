...
SIMULATION_CARLA_DATA_GEN_IMAGE=${SIMULATION_CARLA_DATA_GEN_IMAGE:-"$REGISTRY_URL/simulation/carla_data_gen"}
...
echo "SIMULATION_CARLA_DATA_GEN_IMAGE=$SIMULATION_CARLA_DATA_GEN_IMAGE" >> "$MODULES_DIR/.env"
