...
ACTION_PURE_PURSUIT_IMAGE=${ACTION_PURE_PURSUIT_IMAGE:-"$REGISTRY_URL/action/pure_pursuit_control"}
ACTION_BEHAVIOUR_TREE_IMAGE=${ACTION_BEHAVIOUR_TREE_IMAGE:-"$REGISTRY_URL/action/behaviour_tree"}
ACTION_CONTROLLER_PKG_IMAGE=${ACTION_CONTROLLER_PKG_IMAGE:-"$REGISTRY_URL/action/controller_pkg"}
...
echo "ACTION_PURE_PURSUIT_IMAGE=$ACTION_PURE_PURSUIT_IMAGE" >> "$MODULES_DIR/.env"
echo "ACTION_BEHAVIOUR_TREE_IMAGE=$ACTION_BEHAVIOUR_TREE_IMAGE" >> "$MODULES_DIR/.env"
echo "ACTION_CONTROLLER_PKG_IMAGE=$ACTION_CONTROLLER_PKG_IMAGE" >> "$MODULES_DIR/.env"
